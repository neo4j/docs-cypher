...
Additionally, some Cypher features are not part of GQL and no GQL alternatives currently exist for them.
These features are listed in the page xref:appendix/gql-conformance/cypher-not-gql.adoc[].
