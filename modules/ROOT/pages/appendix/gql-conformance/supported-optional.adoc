...
| G004
| Path variables
| xref:patterns/reference/path-patterns-and-graph-patterns.adoc#path-patterns[Path patterns]
|
...
| xref:patterns/reference/match-modes-and-path-modes.adoc#path-modes[Path modes]
|
...
| xref:patterns/reference/path-patterns-and-graph-patterns.adoc#graph-patterns-rules-variable-references[Graph patterns -> Rules]
|

| G060
| Bounded graph pattern quantifier
| xref:patterns/reference/variable-length-paths.adoc#quantifiers[Quantifiers]
|
...
| Tests a node or relationship against a xref:patterns/reference/node-and-relationship-patterns.adoc#label-expressions[label expression].
