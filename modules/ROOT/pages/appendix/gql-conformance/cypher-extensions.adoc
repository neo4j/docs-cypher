...
While the link:https://www.iso.org/standard/76120.html[GQL Standard] incorporates a lot of capabilities in Cypher, some features of Cypher are not part of GQL and no GQL alternatives currently exist for them.
...
GQL does not support xref:functions/user-defined.adoc[].
