...
The exceptions to this rule are projections such as xref:clauses/return.adoc[`RETURN`] or xref:clauses/with.adoc[`WITH`] with aggregation functions, which operate on the whole table of intermediate results at once.
