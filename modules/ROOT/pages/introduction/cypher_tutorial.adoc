...
It tries to find connections past his immediate neighboring `Person` nodes which are themselves well connected to other actors, and it orders the results by the strength of the recommendation, only returning the seven first rows. 
