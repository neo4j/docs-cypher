...
xref::constraints/examples.adoc#administration-constraints-prop-exist-rels[relationship existence constraints],
...
* For information on using transactions over the HTTP API, see the link:{neo4j-docs-base-uri}/http-api/{page-version}/actions/[HTTP API documentation -> Cypher transaction API].
* For information on using transactions within the embedded Core API, see the link:{neo4j-docs-base-uri}/java-reference/{page-version}/java-embedded/cypher-java[Java Reference -> Cypher queries].
