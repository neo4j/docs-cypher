...
a|
All constraints:
xref::constraints/create-constraints.adoc#create-property-existence-constraints[node and relationship property existence constraints],
xref::constraints/create-constraints.adoc#create-property-type-constraints[node and relationship property type constraints],
xref::constraints/create-constraints.adoc#create-property-uniqueness-constraints[node and relationship property uniqueness constraints],
xref::constraints/create-constraints.adoc#create-key-constraints[node and relationship key constraints].
a|
Only xref::constraints/create-constraints.adoc#create-property-uniqueness-constraints[node and relationship property uniqueness constraints].
