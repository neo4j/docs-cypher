...
a|
All constraints:
xref::constraints/existence.adoc[node and relationship property existence constraints],
xref::constraints/type.adoc[node and relationship property type constraints],
xref::constraints/uniqueness.adoc[node and relationship property uniqueness constraints],
xref::constraints/key.adoc[node and relationship key constraints].
a|
Only xref::constraints/uniqueness.adoc[node and relationship uniqueness constraints].
