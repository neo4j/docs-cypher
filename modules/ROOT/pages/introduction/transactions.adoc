...
For examples of the API or command used to start and commit transactions, refer to the API or tool-specific documentation:
...
* For information on using transactions within link:{neo4j-docs-base-uri}/browser-manual/{current-version}/reference-commands/[Neo4j Browser] or link:{neo4j-docs-base-uri}/operations-manual/{page-version}/tools/cypher-shell/#cypher-shell-commands[Cypher-shell].
