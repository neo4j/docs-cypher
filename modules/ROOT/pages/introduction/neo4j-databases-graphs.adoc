...
| Constraints
a|
xref::constraints/examples.adoc#constraints-examples-node-property-existence[Existence constraints], xref::constraints/examples.adoc#constraints-examples-node-uniqueness[uniqueness constraints], and xref::constraints/examples.adoc#constraints-examples-node-key[`NODE KEY` constraints].
a|
Only xref::constraints/examples.adoc#constraints-examples-node-uniqueness[uniqueness constraints].
