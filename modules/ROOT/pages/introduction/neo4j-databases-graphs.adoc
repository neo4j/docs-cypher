...
xref::constraints/examples.adoc#constraints-examples-node-uniqueness[node uniqueness constraints],
xref::constraints/examples.adoc#constraints-examples-relationship-uniqueness[relationship uniqueness constraints],
...
a|
Only xref::constraints/examples.adoc#constraints-examples-node-uniqueness[node] and xref::constraints/examples.adoc#constraints-examples-relationship-uniqueness[relationship] uniqueness constraints.
