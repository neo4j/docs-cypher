...
_This section discusses aspects of Neo4j that are important to consider when using Cypher._

[[cypher-neo4j-editions]]
== Cypher and the different editions of Neo4j

Neo4j consists of two editions: a commercial Enterprise Edition, and an open-source Community Edition. 
