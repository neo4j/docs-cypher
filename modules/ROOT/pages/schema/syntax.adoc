...
| Returns relationship existence constraints, such as relationship property existence constraints.

| EXIST[ENCE]
| Returns existence constraints, such as property existence and node label existence constraints, for both nodes and relationships.
