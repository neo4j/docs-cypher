...
// tag::schema_create_constraints_property_uniqueness[]
[source, cypher]
----
CREATE CONSTRAINT book_isbn
FOR (book:Book) REQUIRE book.isbn IS UNIQUE
----
// end::schema_create_constraints_property_uniqueness[]
...
// tag::schema_create_constraints_composite_property_uniqueness[]
[source, cypher]
----
CREATE CONSTRAINT prequels
FOR ()-[prequel:PREQUEL_OF]-() REQUIRE (prequel.order, prequel.author) IS UNIQUE
----
// end::schema_create_constraints_composite_property_uniqueness[]
...
// tag::schema_create_constraints_property_existence[]
[source, cypher]
----
CREATE CONSTRAINT author_name
FOR (author:Author) REQUIRE author.name IS NOT NULL
----
// end::schema_create_constraints_property_existence[]
...
// tag::schema_create_constraints_property_type[]
[source, cypher]
----
CREATE CONSTRAINT part_of
FOR ()-[part:PART_OF]-() REQUIRE part.order IS :: INTEGER
----
// end::schema_create_constraints_property_type[]
...
// tag::schema_create_constraints_property_type_dynamic_union[]
[source, cypher]
----
CREATE CONSTRAINT movie_tagline
FOR (movie:Movie) REQUIRE movie.tagline IS :: STRING | LIST<STRING NOT NULL>
----
// end::schema_create_constraints_property_type_dynamic_union[]
...
// tag::schema_create_constraints_parameter[]
[source, cypher]
----
CREATE CONSTRAINT $name
FOR (book:Book) REQUIRE book.prop1 IS UNIQUE
----
// end::schema_create_constraints_parameter[]
...
// tag::schema_create_constraints_if_not_exists[]
[source, cypher]
----
CREATE CONSTRAINT sequels IF NOT EXISTS
FOR ()-[sequel:SEQUEL_OF]-() REQUIRE sequel.order IS UNIQUE
----¨
// end::schema_create_constraints_if_not_exists[]
