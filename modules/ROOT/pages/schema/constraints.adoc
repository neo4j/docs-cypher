...
* xref:schema/constraints.adoc#create-property-uniqueness-constraints[Property uniqueness constraints]: ensure that the combined property values are unique for all nodes with a specific label or all relationships with a specific type. 
* xref:schema/constraints.adoc#create-property-existence-constraints[Property existence constraints]: ensure that a property exists either for all nodes with a specific label or for all relationships with a specific type. label:enterprise-edition[]
* xref:schema/constraints.adoc#create-property-type-constraints[Property type constraints]: ensure that a property has the required property type for all nodes with a specific label or for all relationships with a specific type. label:enterprise-edition[]
* xref:schema/constraints.adoc#create-key-constraints[Key constraints]: ensure that all properties exist and that the combined property values are unique for all nodes with a specific label or all relationships with a specific type.label:enterprise-edition[]
...
* xref:schema/constraints.adoc#create-single-property-uniqueness-constraint[]
* xref:schema/constraints.adoc#create-composite-property-uniqueness-constraint[]
* xref:schema/constraints.adoc#create-property-uniqueness-constraint-compliant-data[]
...
* xref:schema/constraints.adoc#create-single-property-existence-constraint[]
* xref:schema/constraints.adoc#create-property-existence-constraint-compliant-data[]
...
* xref:schema/constraints.adoc#create-single-property-type-constraint[]
* xref:schema/constraints.adoc#create-property-type-constraint-union-type[]
* xref:schema/constraints.adoc#type-constraints-allowed-properties[]
* xref:schema/constraints.adoc#fail-to-create-property-type-constraint-invalid-type[]
* xref:schema/constraints.adoc#create-property-type-constraint-compliant-data[]
...
For the types that properties can be constrained by, see xref:schema/constraints.adoc#type-constraints-allowed-properties[], and for information about different data types in Cypher, see xref:values-and-types/index.adoc[].
...
* xref:schema/constraints.adoc#create-single-property-key-constraint[]
* xref:schema/constraints.adoc#create-composite-key-constraint[]
* xref:schema/constraints.adoc#create-key-constraint-compliant-data[]
...
* xref:schema/constraints.adoc#create-a-constraint-if-not-exist[]
* xref:schema/constraints.adoc#create-an-already-existing-constraint[]
...
* xref:schema/constraints.adoc#constraints-and-backing-indexes[]
* xref:schema/constraints.adoc#constraint-failures-and-indexes[]
...
These indexes are listed in the `owningConstraint` column returned by the xref:indexes/search-performance-indexes/managing-indexes.adoc#list-indexes[`SHOW INDEX`] command, and the `ownedIndex` column returned by the xref:schema/constraints.adoc#list-constraints[`SHOW CONSTRAINT`] command.
...
* xref:schema/constraints.adoc#create-data-that-violates-a-constraint[]
* xref:schema/constraints.adoc#removing-an-existing-constrained-property-will-fail[]
* xref:schema/constraints.adoc#modifying-property-constrained-property-will-fail[]
* xref:schema/constraints.adoc#fail-to-create-constraint-due-to-existing-data[]
...
The name of the constraint can be found using the xref:schema/constraints.adoc#list-constraints[`SHOW CONSTRAINTS` command], given in the output column `name`.
