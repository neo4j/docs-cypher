...
| nodes                                                                                                | relationships                                                                                                                                                           |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [Node[-9]{},Node[-5]{},Node[-6]{},Node[-1]{},Node[-7]{},Node[-3]{},Node[-8]{},Node[-4]{},Node[-2]{}] | [:IMPLIES[-1]{},:IMPLIES[-4]{},:IMPLIES[-5]{},:IMPLIES[-3]{},:IMPLIES[-2]{},:RELATIONSHIP_ELEMENT_TYPE[-6]{},:RELATIONSHIP_ELEMENT_TYPE[-7]{},:RELATIONSHIP_TYPE[-8]{}] |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
----

These lists form the graph:
[source]
----
...
- _Node element type virtual nodes_: these represent a node element type in the graph type.
They contain information around the identifying label, property specifications and any key or uniqueness constraints tied to the node element type.
- _Node constraint virtual nodes_: these represent node constraints that are not tied to any node element type.
They are collected per label, so there is not one such node per constraint but per group of constraints sharing a label.
They contain information around the label and constraints belonging to it.
- _Empty relationship endpoint virtual nodes_: these represent the empty endpoints of relationships.
Either an unconstrainted endpoint of a relationship element type or the empty end point of a relationship constraint not belonging to a relationship element type.
They contain no additional information.

The node element type virtual nodes all have the label `NodeElementType` and then the information about them is stored in their properties:
...
The node constraint virtual nodes all have the label `NodeLabel` and then the information about them is stored in their properties:
...
| `label`
| The label of the node constraints.
| `STRING`
...
The empty relationship endpoint virtual nodes have the label `AnyLabel` and no properties, as they store no additional information.

==== Virtual relationships

There are three different virtual relationships used to represent parts of the graph type.

- _Relationship element type virtual relationships_: these represent a relationship element type in the graph type.
They contain information around the identifying relationship type, property specifications and any key or uniqueness constraints tied to the relationship element type.
- _Relationship constraint virtual relationships_: these represent relationship constraints that are not tied to any relationship element type.
They are collected per relationship type, so there is not one such relationship per constraint but per group of constraints sharing a relationship type.
They contain information around the relationship type and constraints belonging to it.
- _Label implication virtual relationships_: these represent a label implication of a node element type.
They contain no additional information.

The relationship element type virtual relationships all have the relationship type `RELATIONSHIP_ELEMENT_TYPE` and then the information about them is stored in their properties:
...
The relationship constraint virtual relationships all have the relationship type `RELATIONSHIP_TYPE` and then the information about them is stored in their properties:
...
The label implication virtual relationships have relationship type `IMPLIES` and no properties, as they store no additional information.
...
| nodes                                                                                                            | relationships                                                                                                                                                           |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [Node[-10]{},Node[-5]{},Node[-6]{},Node[-1]{},Node[-7]{},Node[-3]{},Node[-8]{},Node[-9]{},Node[-4]{},Node[-2]{}] | [:IMPLIES[-1]{},:IMPLIES[-5]{},:IMPLIES[-4]{},:IMPLIES[-2]{},:IMPLIES[-3]{},:RELATIONSHIP_ELEMENT_TYPE[-6]{},:RELATIONSHIP_ELEMENT_TYPE[-7]{},:RELATIONSHIP_TYPE[-8]{}] |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
----
