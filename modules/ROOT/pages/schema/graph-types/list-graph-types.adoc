...
The query returns two columns: `nodes` and `relationships`.
...
For more information, see xref:schema/graph-types/list-graph-types.adoc#virtual-nodes[virtual nodes] and ref:schema/graph-types/list-graph-types.adoc#virtual-relationships[virtual relationships] below.
