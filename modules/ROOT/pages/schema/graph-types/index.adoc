...
Graph types are *enabled by default*, both in Aura and self-managed Neo4j.

Use the internal setting `internal.dbms.graph_types=false` if you wish to disable it for self-managed Neo4j.
...
* link:https://neo4j.com/blog/developer/graph-type-schema-enforcement-made-easy-preview/[Neo4j Developer Blog: GRAPH TYPE – Schema enforcement made easy (Preview)]