...
For information on native index support and upgrade considerations regarding indexes, see xref:5.0@operations-manual:ROOT:performance/index-configuration.adoc#index-configuration-btree[Operations Manual -> Indexes].
====
...
[NOTE]
====
* For the default directory of other installations see, xref:5.0@operations-manual:ROOT:configuration/file-locations/index.adoc[Operations Manual -> File locations].
