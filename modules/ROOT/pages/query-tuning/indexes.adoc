...
(timothy:Person {name: 'Timothy', age: 25, firstname: 'Peterson'}),
(peter:Person {name: 'Peter', firstname: 'Adam', highScore: 15}),
...
Total database accesses: 20, total allocated memory: 184
----
////
[source, cypher, role=test-setup]
----
...
| +ProduceResults |  0 | person, friend                                              |              0 |    0 |       0 |                |                        |           |                     |
| |               +----+-------------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +Filter         |  1 | r.metIn ENDS WITH $autostring_0 AND r.lastMetIn IS NOT NULL |              0 |    0 |       2 |                |                        |           |                     |
| |               +----+-------------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +Expand(All)    |  2 | (person)-[r:KNOWS]->(friend)                                |              7 |    7 |      14 |                |                        |           |                     |
| |               +----+-------------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +AllNodesScan   |  3 | person                                                      |             10 |    8 |       9 |            120 |                    3/0 |     0.465 | Fused in Pipeline 0 |
+-----------------+----+-------------------------------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+

Total database accesses: 25, total allocated memory: 184
----
