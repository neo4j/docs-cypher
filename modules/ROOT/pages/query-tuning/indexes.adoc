...
// * xref::query-tuning/indexes.adoc#administration-indexes-relationship-btree-index-example[] removed in 5.0
// * xref::query-tuning/indexes.adoc#administration-indexes-node-range-index-example[] missing
