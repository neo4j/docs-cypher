...
----
CREATE 
(andy:Person {name: 'Andy', middlename: 'Beth', surname: 'Anders', age: 36, highScore: 10}),
(timothy:Person {name: 'Timothy', middlename: 'Diane', surname: 'White', age: 25, firstname: 'Peterson', location:point({x: 5, y: 2})}),
(peter:Person {name: 'Peter', firstname: 'Adam', age:16, highScore: 15, location:point({x: 1, y: 2})}),
...
(timothy)-[:KNOWS {since: 1999, lastMet:2005}]->(peter),
  (a:Person {firstname:'Charlie', surname: 'John', age:32, highScore:8, country:'Iceland'}),
  (b:Person {firstname:'Henry', surname: 'Jones', highScore:9, country: 'Japan'}),
  (c:Person {name: 'Caesar', middlename: 'Eriks', location:point({x: 5, y: 7})}),
  (d:Person {name: 'David', middlename: 'Rose', country: 'USA', location:point({x: 1, y: 2})}),
  (e:Person {name: 'George', country: 'UK'}),
  (a)-[:KNOWS {metIn: 'Malmo', lastMetPoint:point({x: 5, y: 11}), since: 2002, lastMetIn: 'London'}]->(b),
  (d)-[:KNOWS {metIn: 'Stockholm', lastMetPoint:point({x: 5, y: 6}), since: 2005, lastMetIn: 'Shanghai'}]->(a),
  (b)-[:KNOWS {lastMetIn: 'Malmo', lastMet:2000}]->(e),
  (c)-[:KNOWS {lastMetIn: 'Stockholm', lastMet:1998}]->(e);
