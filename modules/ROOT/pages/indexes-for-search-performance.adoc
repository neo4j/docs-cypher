...
For more details on these new types, see the xref:5.0@operations-manual:ROOT:performance/index-configuration/index.adoc#future-indexes[Operations Manual -> Future indexes].
