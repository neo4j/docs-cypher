...
// New in 5.8
| `lastRead`
| The last time the index was used for reading, or `null` if it has not yet been read since `trackedSince` or the statistics are not tracked. label:default-output[]
| `DATETIME`
