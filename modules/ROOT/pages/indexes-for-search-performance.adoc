...
+-------------------------------------------------------------------------------------------------------------------------------------------------+
| 4  | "index_664b28a2" | "ONLINE" | 100.0             | "RANGE" | "NODE"     | ["Person"]    | ["middlename"] | "range-1.0"   | <null>           |
| 6  | "index_763f72db" | "ONLINE" | 100.0             | "TEXT"  | "NODE"     | ["Person"]    | ["middlename"] | "text-1.0"    | <null>           |
| 8  | "index_8a688dca" | "ONLINE" | 100.0             | "RANGE" | "NODE"     | ["Person"]    | ["highScore"]  | "range-1.0"   | <null>           |
| 3  | "index_b87724c3" | "ONLINE" | 100.0             | "RANGE" | "NODE"     | ["Person"]    | ["firstname"]  | "range-1.0"   | <null>           |
| 9  | "index_c3493fe4" | "ONLINE" | 100.0             | "POINT" | "NODE"     | ["Person"]    | ["location"]   | "point-1.0"   | <null>           |
| 5  | "index_d1ed0a92" | "ONLINE" | 100.0             | "TEXT"  | "NODE"     | ["Person"]    | ["firstname"]  | "text-1.0"    | <null>           |
| 7  | "index_eadb868e" | "ONLINE" | 100.0             | "TEXT"  | "NODE"     | ["Person"]    | ["surname"]    | "text-1.0"    | <null>           |
+-------------------------------------------------------------------------------------------------------------------------------------------------+
7 rows
----
...
+-----------------------------------------------------------------------------------------------------------------------------------------------------+
| 4  | "index_664b28a2" | "ONLINE" | 100.0             | "RANGE" | "NODE"         | ["Person"]    | ["middlename"] | "range-1.0"   | <null>           |
| 1  | "index_6e62c571" | "ONLINE" | 100.0             | "RANGE" | "RELATIONSHIP" | ["KNOWS"]     | ["since"]      | "range-1.0"   | <null>           |
| 8  | "index_8a688dca" | "ONLINE" | 100.0             | "RANGE" | "NODE"         | ["Person"]    | ["highScore"]  | "range-1.0"   | <null>           |
| 3  | "index_b87724c3" | "ONLINE" | 100.0             | "RANGE" | "NODE"         | ["Person"]    | ["firstname"]  | "range-1.0"   | <null>           |
+-----------------------------------------------------------------------------------------------------------------------------------------------------+
4 rows
