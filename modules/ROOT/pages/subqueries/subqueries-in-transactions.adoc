...
[role="queryresult",stripes="all",cols="1"]
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22N27/[22N27]: error: data exception - invalid entity type. Invalid input 'DATE' for argument at index 0 of function toFloat(). Expected to be FLOAT, INTEGER or STRING.
