...
----
{
  "alias1": "composite.remoteGraph1",
  "alias2": "composite.remoteGraph2"
}
----

Aliases behaviors with composite dbs is erratic and version dependent, so variables help avoiding the mess
...
CREATE ALIAS $alias1 FOR DATABASE `remoteGraph1`;
CREATE ALIAS $alias2 FOR DATABASE `remoteGraph2`;
----
////
