...
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/42N07/[42N07]: error: syntax error or access rule violation - variable shadowing. The variable `name` is shadowing a variable with the same name from the outer scope and needs to be renamed.
