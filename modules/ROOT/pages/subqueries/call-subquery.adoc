...
The `CALL` clause is used to call a subquery.
...
They not explicitly return anything, and this means that the number of rows present after the subquery is the same as was going into the subquery.
