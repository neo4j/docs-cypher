...
[NOTE]
====
Having dots (`.`) in the database alias names are not recommended.
This is due to the difficulty of separating if a dot is part of the database alias name or a delimiter for a database alias in a composite database.
====
