...
Since the first dot will be used as a divider, the command will attempt to create database alias `withdot.myalias` in composite database `mycompositedatabase`.
