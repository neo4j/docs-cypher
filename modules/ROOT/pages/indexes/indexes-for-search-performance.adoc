...
* xref:indexes/indexes-for-search-performance.adoc#create-a-range-index-by-param[]
...
* xref:indexes/indexes-for-search-performance.adoc#create-a-text-index-by-param[]
...
* xref:indexes/indexes-for-search-performance.adoc#create-a-point-index-by-param[]
...
* xref:indexes/indexes-for-search-performance.adoc#drop-an-index-by-param[]
