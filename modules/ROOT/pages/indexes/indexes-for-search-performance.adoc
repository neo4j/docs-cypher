...
This page describes how to create, list, and delete these indexes for search performance.
The following index types are included in this category:

* xref:indexes/indexes-for-search-performance.adoc#indexes-create-range-index[Range indexes]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-text-index[Text indexes]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-point-index[Point indexes]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-token-index[Token lookup indexes]
...
If no index type is specified in the create command a xref:indexes/indexes-for-search-performance.adoc#indexes-create-range-index[range index] will be created.
...
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-single-property-range-index-for-nodes[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-single-property-range-index-for-relationships[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-composite-range-index-for-nodes[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-composite-range-index-for-relationships[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-range-index-only-if-it-does-not-already-exist[]
...
Nodes or relationships with the node label or relationship type where the indexed property is of another value type are not included in the index.
====

[discrete]
==== Examples

* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-node-text-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-relationship-text-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-text-index-only-if-it-does-not-already-exist[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-text-index-specifying-the-index-provider[]
...
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-node-point-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-relationship-point-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-point-index-only-if-it-does-not-already-exist[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-point-index-specifying-the-index-configuration[]
...
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-node-label-lookup-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-relationship-type-lookup-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-create-a-lookup-index-only-if-it-does-not-already-exist[]
...
* xref:indexes/indexes-for-search-performance.adoc#indexes-failure-to-create-an-already-existing-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-failure-to-create-an-index-with-the-same-name-as-an-already-existing-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-failure-to-create-an-index-when-a-constraint-already-exists[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-failure-to-create-an-index-with-the-same-name-as-an-already-existing-constraint[]
...
* xref:indexes/indexes-for-search-performance.adoc#indexes-listing-all-indexes[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-listing-indexes-with-filtering[]
...
This can be used to drop the index with the xref:indexes/indexes-for-search-performance.adoc#indexes-drop-an-index[`DROP INDEX` command].
...
The name of the index can be found using the xref:indexes/indexes-for-search-performance.adoc#indexes-list-indexes[`SHOW INDEXES` command], given in the output column `name`.
...
* xref:indexes/indexes-for-search-performance.adoc#indexes-drop-an-index[]
* xref:indexes/indexes-for-search-performance.adoc#indexes-drop-a-non-existing-index[]
