...
These properties can be used for filtering using the xref:clauses/with.adoc[`WITH`] clause, but they cannot be vector properties.
A vector index can store only one vector property.
|===
