...
=== Syntax [grammar]
:syntax-filename: indexes/create
...
==== Syntax [grammar]
:syntax-filename: indexes/create-range
...
==== Syntax [grammar]
:syntax-filename: indexes/create-text
...
==== Syntax [grammar]
:syntax-filename: indexes/create-point
...
==== Syntax [grammar]
:syntax-filename: indexes/create-lookup
...
==== Syntax [grammar]
:syntax-filename: indexes/create-fulltext
...
==== Syntax [grammar]
:syntax-filename: indexes/create-vector
