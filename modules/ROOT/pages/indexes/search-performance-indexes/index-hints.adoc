...
To replicate results from this page, execute the following query on an empty database.
...
The following query is used in some of the examples on this page.
...
.Query
// tag::indexes_search_performance_hint[]
[source, cypher]
----
PROFILE
MATCH
...
RETURN *
----
// end::indexes_search_performance_hint[]
