...
_cause_: link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22N74/[22N74]: error: data exception - index conflicts with existing constraint. Index conflicts with already existing index owned by constraint `uniqueBookIsbn`.
|===
