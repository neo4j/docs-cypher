...
[role="queryresult",stripes="all",cols="1"]
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22NBC/[22NBC]: error: data exception - index belongs to constraint. Index belongs to constraint 'uniqueBookIsbn'.

_cause_: link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/50N10/[50N10]: error: general processing exception - index drop failed. Unable to drop 'uniqueBookIsbn'.
|===
