...
Instead, an informational notification will be returned detailing that the index does not exist.
...
If an index with that name exists it is removed, if not the command does nothing and an informational notification is returned.
