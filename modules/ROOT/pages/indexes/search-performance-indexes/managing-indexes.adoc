...
* xref:indexes/search-performance-indexes/managing-indexes.adoc#create-token-index[Token lookup indexes]
...
Index providers and configuration settings can be specified using the `OPTIONS` clause.footnote:[Index providers are essentially different implementations of the same index.
