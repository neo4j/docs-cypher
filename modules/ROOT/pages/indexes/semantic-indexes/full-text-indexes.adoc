...
For a full description of all return columns, see xref:indexes/search-performance-indexes/list-indexes.adoc#listing-indexes-result-columns[Search-performance indexes -> Show indexes -> Result columns for showing indexes].
