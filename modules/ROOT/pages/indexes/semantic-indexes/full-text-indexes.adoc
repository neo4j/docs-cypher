...
Unlike search-performance xref:indexes/search-performance-indexes/text search-performance/create-indexes.adoc#create-text-index[text indexes], full-text indexes capture the semantic meaning or context of the data in a database.
