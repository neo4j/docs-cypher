...
[NOTE]
====
It is not possible to automatically transition from a topology with a single primary host, but it is possible to increase the number of primaries from one to more.
