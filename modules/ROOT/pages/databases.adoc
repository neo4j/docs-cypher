...
|===
| +name+ | +type+ | +aliases+ | +access+ | +address+ | +role+ | +writer+ | +requestedStatus+ | +currentStatus+ | +error+ | +default+ | +home+
| +"customers"+ | +standard+ | +[]+ | +"read-only"+ | +"localhost:7687"+ | +"primary"+ | +true+ | +"offline"+ | +"offline"+ | +""+ | +false+ | +false+
10+d|Rows: 1
|===
...
|===
| +name+ | +type+ | +aliases+ | +access+ | +address+ | +role+ | +writer+ | +requestedStatus+ | +currentStatus+ | +error+ | +default+ | +home+
| +"customers"+ | +standard+ | +[]+ | +"read-only"+ | +"localhost:7687"+ | +"primary"+ | +true+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+
10+d|Rows: 1
|===
