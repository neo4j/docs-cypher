...
To create the database and alias, run the following query:
...
| +name+ | +type+ | +aliases+ | +access+ | +address+ | +role+ | +requestedStatus+ | +currentStatus+ | +error+ | +default+ | +home+ | +constituents+
| +"movies"+ | +"standard"+ | +["films","motion pictures"]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +"standard"+ | +false+ | +false+ | +[]+
| +"neo4j"+ | +"standard"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +true+ | +true+ | +[]+
| +"system"+ | +"system"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
10+d|Rows: 3
...
CREATE ALIAS `library`.`romance` FOR DATABASE `sci-fi-books`;
----
...
| +name+ | +type+ | +aliases+ | +access+ | +address+ | +role+ | +requestedStatus+ | +currentStatus+ | +error+ | +default+ | +home+ | + constituents+
| +"customers"+ | +"standard"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
| +"library"+ | +"composite"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"null"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +["library.sci-fi", "library.romance"]+
| +"movies"+ | +"standard"+ | +["films","motion pictures"]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
| +"neo4j"+ | +"standard"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +true+ | +true+ | +[]+
| +"sci-fi-books"+ | +"standard"+ | +["library.sci-fi", "library.romance"]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
| +"system"+ | +"system"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
10+d|Rows: 6
...
| +"customers"+ | +"standard"+ | +"read-write"+ | +"primary"+ | +false+ | +[]+
...
[source, cypher, role=test-setup]
----
DROP ALIAS `library`.`sci-fi` FOR DATABASE;
DROP ALIAS `library`.`romance` FOR DATABASE;
DROP DATABASE `sci-fi-books`;
...
[source, cypher, role=test-setup]
----
DROP DATABASE `topology-example`
----
////
...
[role="queryresult",options="header,footer",cols="10*<m"]
|===
| +name+ | +type+ | +type+ | +aliases+ | +access+ | +address+ | +role+ | +requestedStatus+ | +currentStatus+ | +error+ | +default+ | +home+ | +constituents+
| +"customers"+ | +"standard"+ | +"standard"+ | +[]+ | +"read-only"+ | +"localhost:7687"+ | +"unknown"+ | +"offline"+ | +"offline"+ | +""+ | +false+ | +false+ | +[]+
10+d|Rows: 1
|===
...
|===
| +name+ | +type+ | +aliases+ | +access+ | +address+ | +role+ | +requestedStatus+ | +currentStatus+ | +error+ | +default+ | +home+ | +constituents+
| +"customers"+ | +"standard"+ | +[]+ | +"read-only"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
10+d|Rows: 1
|===
...
|===
| +name+  | +type+ | +aliases+ | +access+ | +address+ | +role+ | +requestedStatus+ | +currentStatus+ | +error+ | +default+ | +home+ | +constituents+
| +"inventory"+  | +"composite"+ | +[]+ | +"read-only"+ | +"localhost:7687"+ | +"null"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
| +"movies"+ | +"standard"+ | +["films","motion pictures"]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
| +"neo4j"+ | +"standard"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +true+ | +true+ | +[]+
| +"system"+ | +"system"+ | +[]+ | +"read-write"+ | +"localhost:7687"+ | +"primary"+ | +"online"+ | +"online"+ | +""+ | +false+ | +false+ | +[]+
10+d|Rows: 3
