...
Cypher includes a several different types of expressions.
More information about each of these can be found in the following sections:

* xref:expressions/case.adoc[]
* xref:expressions/subquery.adoc[]
* xref:expressions/type-predicate.adoc[]
* xref:expressions/label.adoc[]
* xref:expressions/relationship.adoc[]
