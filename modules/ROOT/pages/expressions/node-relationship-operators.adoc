...
image::graph_element_operators.svg["Example graph of three Person nodes with firstName, middleName, and lastName properties, connected by WORKS_FOR relationships that carry a since property",width="600",role="middle"]
