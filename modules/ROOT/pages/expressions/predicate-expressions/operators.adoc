...
----
CREATE (alice:Person {name:'Alice', age: 65, email: 'alice@company.com', occupation: 'Project manager'}),
...
----
MATCH (n:Person)
WHERE n.occupation IN ['Software developer', 'Project manager']
RETURN n.name AS name, n.occupation AS occupation
----
