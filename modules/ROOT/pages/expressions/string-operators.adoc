...
Expressions can also be embedded directly inside a string using xref:values-and-types/boolean-numeric-string.adoc#string-interpolation[string interpolation], which is an alternative to concatenation for building strings.
