...
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22N27/[22N27]: error: data exception - invalid entity type. Invalid input 'STRING' for `date`. Expected to be MAP, NODE, RELATIONSHIP, POINT, DURATION, DATE, ZONED TIME, LOCAL TIME, LOCAL DATETIME or ZONED DATETIME.
