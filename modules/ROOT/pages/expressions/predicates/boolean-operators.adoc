...
image::predicate_operators.svg["Example graph of six unconnected Person nodes, each with name, age, and role properties, several also with an email property",width="500",role="middle"]
