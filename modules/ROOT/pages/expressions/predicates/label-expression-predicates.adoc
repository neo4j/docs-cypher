...
// tag::node-label-expression-predicate-simple[]
[source, cypher]
----
MATCH (p:Person)
RETURN p.name AS name, p:Manager AS isManager
----
// end::node-label-expression-predicate-simple[]
...
// tag::node-label-expression-predicate-or[]
[source, cypher]
----
MATCH (p:Person)
...
----
// end::node-label-expression-predicate-or[]
