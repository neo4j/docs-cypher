...
For more information about Cypher's boolean operators, see xref:expressions/predicates/operators.adoc#boolean-operators[Predicate expressions -> Boolean operators].
