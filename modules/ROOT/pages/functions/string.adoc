...
`trimCharacterString` is a set of characters and `ltrim()` removes any occurrences of these characters from the beginning of the original `STRING` until it discovers a character which is not in the set.
