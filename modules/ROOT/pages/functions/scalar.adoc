...
image::graph-scalar-functions.svg[Example graph connecting people people after their roles as administrator, designer, and developer,role=popup,width=500]
