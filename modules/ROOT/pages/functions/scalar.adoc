...
See the xref::expressions/predicate-expressions/type-predicate-expressions.adoc[type predicate expression] for an alternative way of testing type values.
