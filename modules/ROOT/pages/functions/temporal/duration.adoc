...
| After it has been created, you can query the `DURATION` object for integer values of its components, see xref:values-and-types/temporal.adoc#cypher-temporal-accessing-components-durations[Components of durations].
