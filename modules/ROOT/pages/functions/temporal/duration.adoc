...
Information regarding specifying and accessing components of a `DURATION` value can be found in the page about xref::values-and-types/temporal.adoc#cypher-temporal-durations[Cypher values and types].
