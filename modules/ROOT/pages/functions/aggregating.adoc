...
This examples tries to find all friends of `Keanu Reeves`'s friends, and count them. 
...
| +friendOfFriend.name+ | +count(DISTINCT friend_of_friend)+ | +count(friend_of_friend)+
| +"Guy Pearce"+ | +1+ | +2+
2+d|Rows: 1
