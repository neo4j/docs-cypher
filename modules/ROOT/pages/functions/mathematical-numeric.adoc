...
.Details
|===
| *Syntax* 3+| `round(value)`
| *Description* 3+| Returns the value of a number rounded to the nearest `INTEGER`.
.2+| *Arguments* | *Name* | *Type* | *Description*
...
.Details
|===
| *Syntax* 3+| `round(value, precision)`
| *Description* 3+| Returns the value of a number rounded to the specified precision using rounding mode HALF_UP.
...
| *Description* 3+| Returns the value of a number rounded to the specified precision with the specified rounding mode.
