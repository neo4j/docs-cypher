...
For more details, see the {link-vector-indexes}#indexes-vector-similarity-cosine[vector index documentation].
...
For more details, see the {link-vector-indexes}#indexes-vector-similarity-euclidean[vector index documentation].
