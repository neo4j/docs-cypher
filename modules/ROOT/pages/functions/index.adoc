...
* Vector functions [xref::functions/index.adoc#header-query-functions-vector[Summary]|xref::functions/vector.adoc[Detail]]
...
**xref::functions/vector.adoc[Vector functions]**
