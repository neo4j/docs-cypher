...
* GenAI function [xref::functions/index.adoc#header-query-functions-genai[Summary]|xref::genai-integrations.adoc#single-embedding[Detail]] label:new[Introduced in Aura in 5.16] label:new[Introduced on-prem in 5.17]
...
**xref::genai-integrations.adoc#single-embedding[GenAI function]** label:new[Introduced in Aura in 5.16] label:new[Introduced on-prem in 5.17]
