...
| Returns the value of the specified user attribute from the OIDC claims. Returns `NO_VALUE` if the attribute is not present. label:new[Introduced in Neo4j 2026.03]
|===
