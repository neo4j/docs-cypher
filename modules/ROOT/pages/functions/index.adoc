...
| Returns the given `STRING` with leading and trailing whitespace removed. label:new[Introduced in 5.19]
| `btrim(input :: STRING, trimCharacterString :: STRING) :: STRING`
| Returns the given `STRING` with leading and trailing `trimCharacterString` characters removed. label:new[Introduced in 5.19]
...
| Returns the given `STRING` with leading `trimCharacterString` characters removed. label:new[Introduced in 5.19]
...
| Returns the given `STRING` with trailing `trimCharacterString` characters removed. label:new[Introduced in 5.19]
...
| Returns the given `STRING` with the leading and/or trailing `trimCharacterString` character removed. label:new[Introduced in 5.19]
