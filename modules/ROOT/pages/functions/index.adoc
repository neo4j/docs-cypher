...
* Database functions [xref::functions/index.adoc#header-query-functions-database[Summary]|xref::functions/database.adoc[Detail]]
...
**xref::functions/database.adoc[Database functions]**
