...
| link:{neo4j-docs-base-uri}/java-reference/{page-version}/extending-neo4j/functions/[Extending Neo4j (UDF)]
...
| link:{neo4j-docs-base-uri}/java-reference/{page-version}/extending-neo4j/aggregation-functions[Extending Neo4j (Aggregating UDF)]
...
For developing and deploying user-defined functions in Neo4j, see link:{neo4j-docs-base-uri}/java-reference/{page-version}/extending-neo4j/functions/[Extending Neo4j -> User-defined functions].
