...
* xref:functions/show-functions.adoc#show-all-functions[]
* xref:functions/show-functions.adoc#return-specific-columns[]
* xref:functions/show-functions.adoc#show-functions-with-filtering[]
* xref:functions/show-functions.adoc#composable-show-functions[]

[[show-all-functions]]
=== Show all functions

To show all functions with the default output columns, use the `SHOW FUNCTIONS` command.
...
The `SHOW FUNCTIONS` command can be filtered using the xref:clauses/where.adoc[`WHERE`] clause.
...
:syntax-filename: functions/show-functions
