...
These comprise clauses to manage indexes and constraints.
...
m| xref::constraints/syntax.adoc#constraints[CREATE \| SHOW \| DROP CONSTRAINT]
...
m| xref:constraints/list-constraints.adoc[SHOW CONSTRAINTS].
