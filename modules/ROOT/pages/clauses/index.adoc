...
m| xref::functions/listing-functions.adoc[SHOW FUNCTIONS]
...
| List all servers visible to a cluster.
...
|===
| Clause | Description
m| link:{neo4j-docs-base-uri}/operations-manual/current/database-internals/show-and-terminate-transactions/#terminate-transactions[`TERMINATE TRANSACTIONS`]
