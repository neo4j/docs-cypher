...
|===
| Clause | Description
m| link:{neo4j-docs-base-uri}/operations-manual/current/database-internals/show-and-terminate-transactions/#terminate-transactions[`TERMINATE TRANSACTIONS` (Operations Manual)] // Not live yet
