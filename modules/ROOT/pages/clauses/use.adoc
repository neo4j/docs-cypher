...
When running queries against a link:{neo4j-docs-base-uri}/operations-manual/{page-version}/composite-databases[composite databases], the `USE` clause can also appear as the first clause of:
