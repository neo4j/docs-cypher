...
The xref:functions/datatase.adoc#functions-database-nameFromElementId[graph.byElementId()] function (introduced in Neo4j 5.12), can be used to return the name of a database to which a given element id belongs.
