...
When running queries against a link:{neo4j-docs-base-uri}/operations-manual/{page-version}/composite-database[composite database], the `USE` clause can also appear as the first clause of:
