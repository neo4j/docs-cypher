...
xref:values-and-types/lists.adoc[Lists] and xref:patterns/fixed-length-paths.adoc#path-patterns[paths] are key concepts in Cypher.
...
|===
== Syntax
:syntax-filename: clauses/foreach
