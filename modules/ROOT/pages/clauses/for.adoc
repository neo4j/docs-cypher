...
The list can be a parameter that is passed in, a previously collected result, or another list expression.

`FOR` is the GQL conformant synonym of xref:clauses/unwind.adoc[`UNWIND`].
