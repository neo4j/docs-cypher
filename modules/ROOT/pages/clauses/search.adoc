...
== SEARCH clause template

The `SEARCH` clause has the following templates:

.`SEARCH` clause template for vector and full-text search
[.tabbed-example]
=====
...
Below follows a short description of the different parts of the template:
