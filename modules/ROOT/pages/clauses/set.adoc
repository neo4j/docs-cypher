...
.Query
// tag::clauses_set_with_expression[]
[source, cypher]
----
MATCH (n {name: 'Andy'})
...
----
// end::clauses_set_with_expression[]
...
.Query
// tag::clauses_set_dynamic_property[]
[source, cypher]
----
MATCH (n)
...
----
// end::clauses_set_dynamic_property[]

The xref:clauses/foreach.adoc[`FOREACH`] clause iterates over each property key `k` obtained from the xref::functions/list.adoc#functions-keys[`keys()`] function.
...
.Query
// tag::clauses_set_parameter_all_properties[]
[source, cypher]
----
MATCH (n {name: 'Andy'})
SET n = $props
...
----
// end::clauses_set_parameter_all_properties[]
