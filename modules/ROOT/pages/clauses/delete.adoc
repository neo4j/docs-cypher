...
If you intend to recreate the existing indexes and constraints in the new database, first run xref:constraints/list-constraints.adoc[`SHOW CONSTRAINTS`]/xref:indexes/search-performance-indexes/list-indexes.adoc[`SHOW INDEXES`] and return the specific `createStatement`.
...
+-----------------------------------------------------------------------------------------------------------+
| "person_name_key" | "CREATE CONSTRAINT `person_name_key` FOR (n:`Person`) REQUIRE (n.`name`) IS NODE KEY" |
+-----------------------------------------------------------------------------------------------------------+
----
