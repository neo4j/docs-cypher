...
This can be done by either explictly deleting the relations, or by using the `DETACH DELETE` clause. 
...
It is possible to only delete relationships, leaving the node(s) connected to those relationships otherwise unaffected.
