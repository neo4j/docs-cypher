...
Read more about this capability in xref::appendix/tutorials/advanced-example.adoc#advanced-query-tuning-example-index-backed-order-by[Index-backed ORDER BY].
