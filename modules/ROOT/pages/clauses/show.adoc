...
* link:{neo4j-docs-base-uri}/current/database-administration/syntax/#_show_aliases[Show aliases (Operations Manual)]
...
* link:{neo4j-docs-base-uri}/operations-manual/current/[Show transactions (Operations Manual)] // TODO: Move to Ops Manual
