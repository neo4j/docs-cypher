...
* xref:schema/constraints/list-constraints.adoc#composable-show-constraints[`SHOW CONSTRAINTS`]
* xref:schema/graph-types/list-graph-types.adoc#composable-show-graph-types[`SHOW CURRENT GRAPH TYPE`]
* link:{neo4j-docs-base-uri}/operations-manual/current/authentication-authorization/manage-users/#access-control-current-users[`SHOW CURRENT USER` (Operations Manual)] label:new[Introduced in Neo4j 2026.10]
* link:{neo4j-docs-base-uri}/operations-manual/current/database-administration/standard-databases/listing-databases/#_show_quarantined_databases_and_lift_their_quarantine[`SHOW DATABASES` (Operations Manual)]
* xref:functions/show-functions.adoc#composable-show-functions[`SHOW FUNCTIONS`]
* xref:indexes/search-performance-indexes/list-indexes.adoc#composable-show-indexes[`SHOW INDEXES`]
* link:{neo4j-docs-base-uri}/operations-manual/current/procedures/show-procedures/#composable-show-procedures[`SHOW PROCEDURES` (Operations Manual)]
* link:{neo4j-docs-base-uri}/operations-manual/current/configuration/show-settings/#combine-show-settings-with-general-cypher[`SHOW SETTINGS` (Operations Manual)]
* link:{neo4j-docs-base-uri}/operations-manual/current/database-internals/show-and-terminate-transactions/#_combine_transaction_commands_with_other_cypher_commands[`SHOW TRANSACTIONS` (Operations Manual)] -- it has been possible to combine `SHOW TRANSACTIONS` with `TERMINATE TRANSACTIONS` since Neo4j 5.0.
...
The below snippets are extracted from the xref:appendix/grammar/index.adoc[full Cypher grammar].

.show-standalone
[source, gql-bnf, subs="+macros,+quotes", role=nocollapse]
----
include::example$syntax/clauses/show-standalone.bnf[]
----

.Railroad diagram of the snippet
[%collapsible]
====
image::syntax/clauses/show-standalone.svg["Railroad diagram for 'clauses/show-standalone'"]
====

.show-primitive
[source, gql-bnf, subs="+macros,+quotes", role=nocollapse]
----
include::example$syntax/clauses/show-primitive.bnf[]
----

.Railroad diagram of the snippet
[%collapsible]
====
image::syntax/clauses/show-primitive.svg["Railroad diagram for 'clauses/show-primitive'"]
====

.show-result-clause
[source, gql-bnf, subs="+macros,+quotes", role=nocollapse]
----
include::example$syntax/clauses/show-result-clause.bnf[]
----

.Railroad diagram of the snippet
[%collapsible]
====
image::syntax/clauses/show-result-clause.svg["Railroad diagram for 'clauses/show-result-clause'"]
====