...
The following `SHOW` commands can be combined with other Cypher clauses; see their respective sections for examples:
...
* link:{neo4j-docs-base-uri}/operations-manual/current/database-administration/standard-databases/listing-databases/#_show_quarantined_databases_and_restore_access[`SHOW DATABASES` (Operations Manual)]
