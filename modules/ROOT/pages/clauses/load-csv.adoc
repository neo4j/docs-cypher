...
See link:{neo4j-docs-base-uri}/operations-manual/current/backup-restore/restore-dump/#load-dump-cloud-storage[Load a dump from a cloud storage] on how to set up access to cloud storages.
