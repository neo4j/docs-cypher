...
Quoted strings are allowed in the CSV file and the quotes are dropped when `LOAD CSV` reads the data. If quoted strings need to contain quote charachters `"`, there are two ways to escape them:
