...
xref:5.0@operations-manual:ROOT:reference/configuration-settings/index.adoc#config_dbms.directories.import[dbms.directories.import]::
...
This is a security measure which prevents the database from accessing files outside the standard xref:5.0@operations-manual:ROOT:configuration/file-locations/index.adoc[import directory],
