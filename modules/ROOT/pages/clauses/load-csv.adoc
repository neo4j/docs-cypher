...
As of Neo4j 5.19, `LOAD CSV` additionally supports S3 URIs.
...
`LOAD CSV` supports accessing CSV files via HTTPS, HTTP, FTP.
As of Neo4j 5.19, `LOAD CSV` additionally supports S3.
