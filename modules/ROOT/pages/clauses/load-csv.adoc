...
* When using `+file:///+` URLs, spaces and other non-alphanumeric characters need to be URL encodedfootnote:[See https://developer.mozilla.org/en-US/docs/Glossary/percent-encoding].
