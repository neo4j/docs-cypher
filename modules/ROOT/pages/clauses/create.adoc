...
As of Neo4j 5.18, multiple labels can also be separated by an ampersand `&`, in the same manner as it is used in xref:patterns/reference/node-and-relationship-patterns.adoc#label-expressions[label expressions].
