...
[NOTE]
====
Neo4j 2026.07 also features changes to the visibility of expressions in `WHERE` and `ORDER BY` clauses.
See xref:functions/aggregating.adoc#grouping-keys[Aggregating expressions and grouping keys] for details.
====
