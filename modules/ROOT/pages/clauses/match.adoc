...
For more information about finding node patterns, see xref:patterns/fixed-length-paths#node-patterns[Patterns -> Node patterns].
...
For more information about relationship patterns, see xref:patterns/fixed-length-paths#relationship-patterns[Patterns -> Relationship patterns].
