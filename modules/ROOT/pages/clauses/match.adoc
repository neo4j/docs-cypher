...
.Diagram within a collapsible block (custom colors)
[%collapsible]
====
image::railroad/railroad-all-short-colors.svg["Railroad diagram example", opts=interactive]
====
