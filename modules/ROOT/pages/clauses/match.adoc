...
image:graph_match_clause.svg[width="700", align="center"]
...
image:graph_match_clause_variable_length.svg[width="700", align="center"]
...
image:MATCH_properties_on_variable_length_path.svg[width="400", align=center]
