...
For more information about how `MATCH` is used to find patterns (including quantified path patterns, quantified relationships, and shortest path), see the section on xref::patterns/index.adoc[Patterns].
