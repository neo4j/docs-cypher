...
[role="queryresult",stripes="all",cols="1"]
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22N78/[22N78]: data exception - property type verification failed. NODE (108) with label 'Product' must have the property `id` with value type INTEGER.
|===
