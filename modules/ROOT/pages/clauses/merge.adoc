...
.`MERGE` a node that abides to key constraint
[source, cypher]
----
...
.`MERGE` a node that abides to property type constraint
[source, cypher]
----
...
.`MERGE` a node that casts data type and abides to property type constraint 
[source, cypher]
----
