...
:page-aliases: clauses/create-unique.adoc
...
| +"Keanu Reeves"+ | +1660054738057+ | +<null>+
3+d|Rows: 1 +
Nodes created: 1 +
Properties set: 2 +
Labels added: 1
...
| +"Charlie Sheen"+ | +true+ | +1660054739049+
| +"Martin Sheen"+ | +true+ | +1660054739049+
| +"Michael Douglas"+ | +true+ | +1660054739049+
| +"Oliver Stone"+ | +true+ | +1660054739049+
| +"Rob Reiner"+ | +true+ | +1660054739049+
3+d|Rows: 5 +
Properties set: 10
|===
