...
| +"Keanu Reeves"+ | +1664451653804+ | +<null>+
3+d|Rows: 1 +
Nodes created: 1 +
Properties set: 2 +
Labels added: 1
...
| +"Charlie Sheen"+ | +true+ | +1664451654388+
| +"Martin Sheen"+ | +true+ | +1664451654388+
| +"Michael Douglas"+ | +true+ | +1664451654388+
| +"Oliver Stone"+ | +true+ | +1664451654388+
| +"Rob Reiner"+ | +true+ | +1664451654388+
3+d|Rows: 5 +
Properties set: 10
|===
