...
// If we use the width of 500px here, the image gets too small.
// Either we stick to the same size and count on people clicking on the image for the popup or use exceptions when needed. 
// Another option is allowing the image to expand to the full width of the content box.
