...
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22N46/[22N46]: error: data exception - unsupported use of parallel runtime. Parallel runtime does not support updating queries or a change in the state of transactions. Use another runtime.

link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22000/[22000]: error: data exception
|===
...
| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_awaitIndex[`db.awaitIndex()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_awaitIndexes[`db.awaitIndexes()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_checkpoint[`db.checkpoint()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_info[`db.info()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_labels[`db.labels()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_listLocks[`db.listLocks()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_ping[`db.ping()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_propertyKeys[`db.propertyKeys()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_prepareForReplanning[`db.prepareForReplanning()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_relationshipTypes[`db.relationshipTypes()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_resampleIndex[`db.resampleIndex()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_resampleOutdatedIndexes[`db.resampleOutdatedIndexes()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_schema_nodeTypeProperties[`db.schema.nodeTypeProperties()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_schema_relTypeProperties[`db.schema.relTypeProperties()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_db_schema_visualization[`db.schema.visualization()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_dbms_checkConfigValue[`dbms.checkConfigValue()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_dbms_listActiveLocks[`dbms.listActiveLocks()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_dbms_listPools[`dbms.listPools()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_dbms_scheduler_failedJobs[`dbms.scheduler.failedJobs()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_dbms_scheduler_groups[`dbms.scheduler.groups()`]

| link:{neo4j-docs-base-uri}/operations-manual/current/procedures/built-in-procedures/#procedure_dbms_scheduler_jobs[`dbms.scheduler.jobs()`]
...
The user-defined function below does not fail with the parallel runtime.
Instead, the Cypher query gets automatically run on the pipelined runtime.
