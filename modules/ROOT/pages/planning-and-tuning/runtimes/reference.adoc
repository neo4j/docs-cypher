...
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22N46/[22N46]: Parallel runtime does not support updating queries or a change in the state of transactions. Use another runtime.
