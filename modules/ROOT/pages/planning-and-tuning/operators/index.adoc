...
| responsible for cleaning up the state produced by xref:planning-and-tuning/operators/operators-detail.adoc#query-plan-repeat-trail[`Repeat(Trail)`].
...
| xref::planning-and-tuning/operators/operators-detail.adoc#query-plan-transaction-apply[TransactionForeach]
