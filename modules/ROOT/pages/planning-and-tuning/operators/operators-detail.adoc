...
The `AssertingMultiRelationshipIndexSeek` operator is used to ensure that no xref:constraints/create-constraints.adoc#create-property-uniqueness-constraints[property uniqueness constraints] are violated when creating relationships.
