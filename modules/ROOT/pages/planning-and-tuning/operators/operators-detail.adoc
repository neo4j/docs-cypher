...
| |                                      +----+------------------------------------------------------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     +--------------+
| +Projection                            |  1 | r.content AS content, cache[r.rating] AS rating                                                      |              1 |    0 |       0 |                |                        |           |                     |              |
| |                                      +----+------------------------------------------------------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     +--------------+
| +DirectedRelationshipVectorIndexSearch |  2 | SEARCH ()-[r:REVIEWED]->() IN (VECTOR INDEX reviews FOR RuntimeConstant(vector($autolist_0, $autoint |              1 |    0 |       1 |            248 |                    0/0 |     0.548 | Fused in Pipeline 0 | reviews: 1   |
...
| |                                        +----+------------------------------------------------------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     +--------------+
| +Projection                              |  1 | r.content AS content, cache[r.rating] AS rating                                                      |              2 |    0 |       0 |                |                        |           |                     |              |
| |                                        +----+------------------------------------------------------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     +--------------+
| +UndirectedRelationshipVectorIndexSearch |  2 | SEARCH ()-[r:REVIEWED]-() IN (VECTOR INDEX reviews FOR RuntimeConstant(vector($autolist_0, $autoint_ |              2 |    0 |       1 |            248 |                    0/0 |     0.553 | Fused in Pipeline 0 | reviews: 1   |
