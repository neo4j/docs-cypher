...
[NOTE]
====
`MergeUniqueNode` has been added in Cypher 2025.11 but it did not work as intended in that version.
For this reason, the operator has been disabled in Cypher 2025.12.
Cypher 2026.02 contains a fix which makes it the first Cypher version with the operator working as intended. 
====
