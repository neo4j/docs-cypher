...
The `NodeVectorIndexSearch` operator is used to search a vector index for similar vector embeddings.
...
[role=label--new-2026.01]
The `DirectedRelationshipVectorIndexSearch` operator is used to search a vector index for similar vector embeddings.
...
[role=label--new-2026.01]
The `UndirectedRelationshipVectorIndexSearch` operator is used to search a vector index for similar vector embeddings.
