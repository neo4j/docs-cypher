...
[NOTE]
For information about the metrics on query cache usage, refer to the link:{neo4j-docs-base-uri}/operations-manual/current/monitoring/metrics/reference/#cypher-metrics[Operations Manual -> Cypher planning and caching metrics].
