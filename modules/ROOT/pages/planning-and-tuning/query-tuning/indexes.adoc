...
For instructions on how to create and maintain indexes, refer to xref:indexes/search-performance-indexes/managing-indexes.adoc[].
...
See xref:indexes/semantic-indexes/full-text-indexes.adoc[].
====
...
But in these cases rewrites might happen depending on which properties have which predicates, see xref:indexes/search-performance-indexes/managing-indexes.adoc#indexes-single-vs-composite-index[composite index limitations].
...
However, predicates after the range predicate may be rewritten as an existence check predicate and a filter as described in xref:indexes/search-performance-indexes/managing-indexes.adoc#indexes-single-vs-composite-index[composite index limitations].
...
More information about how the rewriting works can be found in xref:indexes/search-performance-indexes/managing-indexes.adoc#indexes-single-vs-composite-index[composite index limitations].
