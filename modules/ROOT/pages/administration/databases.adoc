...
[NOTE]
====
The returned map contains all options including the immutable options that are only valid during database creation.
====
...
The `ALTER DATABASE` command can be used to set or remove specific options.
