...
Also note that Cypher 25 is required to use The `VECTOR` supertypes in link:{neo4j-docs-base-uri}/cypher-manual/current/expressions/predicates/type-predicate-expressions/#type-predicate-vector[type predicate expressions].
