...
Homogeneous lists of simple types can also be stored as properties, although lists in general (see xref::values-and-types/property-structural-composite.adoc#composite-types[Composite types]) cannot be stored.
