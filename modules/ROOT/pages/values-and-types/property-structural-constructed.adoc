...
Note that closed dynamic types (`INNER_TYPE_1 | INNER_TYPE_2...`) cannot be appended with `NOT NULL`, instead all inner types must be nullable, or all appended with `NOT NULL`.
