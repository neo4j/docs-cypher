...
These types (and their synonyms) can be used in xref::expressions/predicate-expressions/type-predicate-expressions.adoc[type predicate expressions] and in xref::constraints/managing-constraints.adoc#create-property-type-constraints[property type constraints].
...
This normalization is run on types used in xref::expressions/predicate-expressions/type-predicate-expressions.adoc[type predicate expressions], and in xref::constraints/managing-constraints.adoc#create-property-type-constraints[property type constraints].
