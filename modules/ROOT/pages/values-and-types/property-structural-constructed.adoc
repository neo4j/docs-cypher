...
These types (and their synonyms) can be used in xref::values-and-types/type-predicate.adoc[type predicate expressions] and in xref::constraints/type.adoc[node and relationship] property type constraints.
...
This normalization is run on types used in xref::values-and-types/type-predicate.adoc[type predicate expressions], and in xref::constraints/type.adoc[node and relationship]property type constraints.
