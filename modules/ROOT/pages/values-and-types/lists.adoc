...
[IMPORTANT]
Lists containing xref:values-and-types/vector.adoc[`VECTOR`] values as nested entries cannot be stored as properties.
...
|===
| link:https://neo4j.com/docs/status-codes/current/errors/gql-errors/22N39/[22N39]: error: data exception - unsupported property value type. Value String("hello") cannot be stored in properties.
