...
The  xref:expressions/predicates/operators.adoc#comparison-operators[equality (`=`) and inequality (`<>`) operators] allows for comparing the equality of different values.
