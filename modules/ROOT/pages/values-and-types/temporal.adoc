...
The following query shows how to extract the date related components of a `ZONED DATETIME` value:
...
The following query shows how to extract the time related components of a `ZONED DATETIME` value:
...
The following query shows how to extract the epoch time and timezone related components of a `ZONED DATETIME` value:
...
.Extract the month based components of a `DURATION` value
======
...
.Extract the day based components of a `DURATION` value
======
...
.Extract the most significant second based components of a `DURATION` value
======
...
.Extract the less significant second based components of a `DURATION` value
======
