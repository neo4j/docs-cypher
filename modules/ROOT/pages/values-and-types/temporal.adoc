...
See tables _First order `DURATION` components_ and _Second order `DURATION` components_ in <<cypher-temporal-accessing-components-durations>>.
...
See table _First order `DURATION` components_ in <<cypher-temporal-accessing-components-durations>>.
