...
Using Cypher's xref::functions/temporal/format.adoc#query-functions-temporal-format-function[`format()`], you can create dynamically formatted string representations of temporal instance and duration types.
...
.A string representation of a duration type
======
