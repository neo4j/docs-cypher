...
This means that xref::expressions/predicate-expressions/type-predicate-expressions.adoc#type-predicate-null[type predicate expressions] always return `true` for `null` values.
