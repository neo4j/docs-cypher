...
* xref::expressions/expressions-overview.adoc#expressions-string-literals[String literal escape sequences]
* xref::syntax/naming.adoc#symbolic-names-escaping-rules[Using special characters in names]
* xref::expressions/predicate-expressions/operators.adoc#regular-expressions[Regular expressions]
