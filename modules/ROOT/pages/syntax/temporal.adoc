...
The default time zone of the database can be configured using the configuration option xref:5.0@operations-manual:ROOT:reference/configuration-settings/index.adoc#config_db.temporal.timezone[`db.temporal.timezone`].
