...
Cypher will thus regard any exact numerical parameter as an `INTEGER`, regardless of if it is declared as e.g. an INT16 or an INT64 in the client programming language.
