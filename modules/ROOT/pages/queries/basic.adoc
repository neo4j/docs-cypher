...
[NOTE]
The quantifier used in the above two examples was introduced with the release of xref::patterns/variable-length-paths.adoc#quantified-path-patterns[quantified path patterns] in Neo4j 5.9.
