...
Having a basic understanding of what nodes, relationships, and paths are in a graph is therefore crucial in order to construct Cypher queries.
...
Paths in a graph consist connected of nodes and relationships.
