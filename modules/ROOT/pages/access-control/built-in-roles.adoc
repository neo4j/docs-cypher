...
* <<access-control-built-in-roles-public, The `PUBLIC` role>>
* <<access-control-built-in-roles-reader, The `reader` role>>
* <<access-control-built-in-roles-editor, The `editor` role>>
* <<access-control-built-in-roles-publisher, The `publisher` role>>
* <<access-control-built-in-roles-architect, The `architect` role>>
* <<access-control-built-in-roles-admin, The `admin` role>>
...
The `publisher` role can do the same as <<access-control-built-in-roles-editor,`editor`>>, as well as create new labels, property keys and relationship types.
...
The `architect` role can do the same as the <<access-control-built-in-roles-publisher,`publisher`>>, as well as create and manage indexes and constraints.
...
The `admin` role can do the same as the <<access-control-built-in-roles-architect,`architect`>>, as well as manage databases, aliases, users, roles and privileges.
...
* Manage <<access-control-database-administration, database security>> to control the rights to perform actions on specific databases:
...
** Manage transactions
* Manage <<access-control-dbms-administration, DBMS security>> to control the rights to perform actions on the entire system:
** Manage <<administration-databases, multiple databases>>.
** Manage <<access-control-manage-users, users>> and <<access-control-manage-roles, roles>>.
** Change configuration parameters.
** Manage sub-graph privileges.
** Manage procedure security.

These rights are conferred using privileges that can be managed through the <<access-control-graph-privileges,`GRANT`, `DENY` and `REVOKE` commands>>.
...
Additional information about restoring the `admin` role can be found at <<operations-manual#recover-admin-role, Operations Manual -> Recover the admin role>>.
