...
This means that, if the security model causes fewer results to be returned due to restricted read access in <<access-control-manage-privileges, Graph and sub-graph access control>>,
