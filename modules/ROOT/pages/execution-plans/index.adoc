...
Information about how the statistics are kept up to date, as well as configuration options for managing query replanning and caching, can be found in the xref:5.0@operations-manual:ROOT:performance/statistics-execution-plans/index.adoc[Operations Manual -> Statistics and execution plans].
