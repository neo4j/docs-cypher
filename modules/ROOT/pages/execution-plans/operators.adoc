...
| |               +---------+----------------+------+---------+----------------+---------------------+
| +AllNodesScan   | n       |             35 |   35 |      36 |             64 | Fused in Pipeline 0 |
+-----------------+---------+----------------+------+---------+----------------+---------------------+

Total database accesses: 36, total allocated memory: 64
...
| |                             +----------------------------------------------+----------------+------+---------+----------------+---------------------+
| +DirectedRelationshipByIdSeek | (n1)-[r]->(anon_17) WHERE id(r) = $autoint_0 |              1 |    1 |       1 |             64 | Fused in Pipeline 0 |
+-------------------------------+----------------------------------------------+----------------+------+---------+----------------+---------------------+
...
| |               +----------------------------+----------------+------+---------+----------------+---------------------+
| +NodeByIdSeek   | n WHERE id(n) = $autoint_0 |              1 |    1 |       1 |             64 | Fused in Pipeline 0 |
+-----------------+----------------------------+----------------+------+---------+----------------+---------------------+
...
| |                +---------------+----------------+------+---------+----------------+---------------------+
| +NodeByLabelScan | person:Person |             14 |   14 |      15 |             64 | Fused in Pipeline 0 |
+------------------+---------------+----------------+------+---------+----------------+---------------------+

Total database accesses: 15, total allocated memory: 64
...
+-----------------+----------------------------------------------------+----------------+------+---------+----------------+-------------------+---------------------+
| +ProduceResults | location                                           |              1 |    1 |       0 |                | location.name ASC | Fused in Pipeline 0 |
| |               +----------------------------------------------------+----------------+------+---------+----------------+-------------------+---------------------+
| +NodeIndexSeek  | location:Location(name) WHERE name = $autostring_0 |              1 |    1 |       2 |             64 | location.name ASC | Fused in Pipeline 0 |
+-----------------+----------------------------------------------------+----------------+------+---------+----------------+-------------------+---------------------+
...
| Operator             | Details                                        | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Order      | Other               |
+----------------------+------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +ProduceResults      | t                                              |              1 |    0 |       0 |                | t.name ASC | Fused in Pipeline 0 |
| |                    +------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +NodeUniqueIndexSeek | UNIQUE t:Team(name) WHERE name = $autostring_0 |              1 |    0 |       1 |             64 | t.name ASC | Fused in Pipeline 0 |
+----------------------+------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
...
+---------------------+----------------------------------------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-------------------+---------------+
| +ProduceResults     | location, person                                                                                   |              1 |    1 |       0 |                |     0.524 | location.name ASC | In Pipeline 0 |
| |                   +----------------------------------------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-------------------+---------------+
| +MultiNodeIndexSeek | location:Location(name) WHERE name = $autostring_0, person:Person(name) WHERE name = $autostring_1 |              1 |    1 |       4 |             64 |     6.436 | location.name ASC | In Pipeline 0 |
+---------------------+----------------------------------------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-------------------+---------------+

Total database accesses: 4, total allocated memory: 64
...
| Operator              | Details                                               | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Order      | Other               |
+-----------------------+-------------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +ProduceResults       | l                                                     |              2 |    1 |       0 |                | l.name ASC | Fused in Pipeline 0 |
| |                     +-------------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +NodeIndexSeekByRange | l:Location(name) WHERE name STARTS WITH $autostring_0 |              2 |    1 |       2 |             64 | l.name ASC | Fused in Pipeline 0 |
+-----------------------+-------------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
...
| Operator                    | Details                                                  | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Order      | Other               |
+-----------------------------+----------------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +ProduceResults             | t                                                        |              2 |    0 |       0 |                | t.name ASC | Fused in Pipeline 0 |
| |                           +----------------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +NodeUniqueIndexSeekByRange | UNIQUE t:Team(name) WHERE name STARTS WITH $autostring_0 |              2 |    0 |       1 |             64 | t.name ASC | Fused in Pipeline 0 |
+-----------------------------+----------------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
...
| Operator               | Details                                            | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Order      | Other               |
+------------------------+----------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +ProduceResults        | l                                                  |              0 |    2 |       0 |                | l.name ASC | Fused in Pipeline 0 |
| |                      +----------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +NodeIndexContainsScan | l:Location(name) WHERE name CONTAINS $autostring_0 |              0 |    2 |       3 |             64 | l.name ASC | Fused in Pipeline 0 |
+------------------------+----------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
...
| Operator               | Details                                             | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Order      | Other               |
+------------------------+-----------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +ProduceResults        | l                                                   |              0 |    0 |       0 |                | l.name ASC | Fused in Pipeline 0 |
| |                      +-----------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +NodeIndexEndsWithScan | l:Location(name) WHERE name ENDS WITH $autostring_0 |              0 |    0 |       1 |             64 | l.name ASC | Fused in Pipeline 0 |
+------------------------+-----------------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
...
| |               +-------------------------------------+----------------+------+---------+----------------+---------------------+
| +NodeIndexScan  | l:Location(name) WHERE exists(name) |             10 |   10 |      11 |             64 | Fused in Pipeline 0 |
+-----------------+-------------------------------------+----------------+------+---------+----------------+---------------------+
...
| |                               +---------------------------------------------+----------------+------+---------+----------------+---------------------+
| +UndirectedRelationshipByIdSeek | (n1)-[r]-(anon_16) WHERE id(r) = $autoint_0 |              1 |    2 |       1 |             64 | Fused in Pipeline 0 |
+---------------------------------+---------------------------------------------+----------------+------+---------+----------------+---------------------+
...
| Operator         | Details                                   | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order      | Other               |
+------------------+-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +ProduceResults  | p, q                                      |              1 |    0 |       0 |                |           | p.name ASC | Fused in Pipeline 1 |
| |                +-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +Apply           |                                           |              1 |    0 |       0 |                |           | p.name ASC |                     |
| |\               +-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| | +NodeIndexSeek | q:Person(name) WHERE name = p.secondName  |              1 |    0 |       0 |             72 |           |            | Fused in Pipeline 1 |
| |                +-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +NodeIndexSeek   | p:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |             64 |     0.280 | p.name ASC | In Pipeline 0       |
+------------------+-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
...
+--------------------+---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults    | `p.name`                              |             11 |    2 |       0 |               0 |                 0 |               0.0000 |
| |                  +---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection        | cache[p.name] AS `p.name`             |             11 |    2 |       2 |               1 |                 0 |               1.0000 |
| |                  +---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SemiApply         |                                       |             11 |    2 |       0 |               0 |                 0 |               0.0000 |
| |\                 +---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +CacheProperties | cache[p.name]                         |              2 |    0 |       0 |               0 |                 0 |               0.0000 |
| | |                +---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter          | anon_45:Person                        |              2 |    0 |       2 |               1 |                 0 |               1.0000 |
| | |                +---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)     | (p)-[anon_27:FRIENDS_WITH]->(anon_45) |              2 |    2 |      33 |              15 |                 0 |               1.0000 |
| | |                +---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument        | p                                     |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                  +---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan   | p:Person                              |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
+--------------------+---------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
+--------------------+--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +ProduceResults    | `other.name`                               |              4 |   13 |       0 |                |               0 |                 0 |               0.0000 | me.name ASC |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +Projection        | other.name AS `other.name`                 |              4 |   13 |      13 |                |               2 |                 0 |               1.0000 | me.name ASC |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +AntiSemiApply     |                                            |              4 |   13 |       0 |                |               0 |                 0 |               0.0000 | me.name ASC |
| |\                 +--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| | +Expand(Into)    | (me)-[anon_62:FRIENDS_WITH]->(other)       |              0 |    0 |      55 |           9984 |              15 |                 0 |               1.0000 |             |
| | |                +--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| | +Argument        | me, other                                  |             14 |   14 |       0 |                |               0 |                 0 |               0.0000 |             |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +CartesianProduct  |                                            |             14 |   14 |       0 |                |               0 |                 0 |               0.0000 | me.name ASC |
| |\                 +--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| | +NodeByLabelScan | other:Person                               |             14 |   14 |      15 |                |               2 |                 0 |               1.0000 |             |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +NodeIndexSeek     | me:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |                |               0 |                 1 |               0.0000 | me.name ASC |
+--------------------+--------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+

Total database accesses: 85, total allocated memory: 9984
...
| Operator           | Details                                    | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order       | Other               |
+--------------------+--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| +ProduceResults    | `other.name`                               |              4 |   13 |       0 |                |     0.321 | me.name ASC | In Pipeline 4       |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| +Projection        | other.name AS `other.name`                 |              4 |   13 |      26 |                |     0.442 | me.name ASC | In Pipeline 4       |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| +Apply             |                                            |              4 |   13 |       0 |                |           | me.name ASC |                     |
| |\                 +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| | +Anti            |                                            |             14 |   13 |       0 |                |     0.161 |             | In Pipeline 4       |
| | |                +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| | +Limit           | 1                                          |             14 |    1 |       0 |                |           |             | Fused in Pipeline 3 |
| | |                +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| | +Expand(Into)    | (me)-[anon_62:FRIENDS_WITH]->(other)       |              0 |    1 |      55 |           2728 |           |             | Fused in Pipeline 3 |
| | |                +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| | +Argument        | me, other                                  |             14 |   14 |       0 |            400 |           |             | Fused in Pipeline 3 |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| +CartesianProduct  |                                            |             14 |   14 |       0 |            288 |     0.289 | me.name ASC | In Pipeline 2       |
| |\                 +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| | +NodeByLabelScan | other:Person                               |             14 |   14 |      15 |             80 |     0.171 |             | In Pipeline 1       |
| |                  +--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+
| +NodeIndexSeek     | me:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |             64 |     0.297 | me.name ASC | In Pipeline 0       |
+--------------------+--------------------------------------------+----------------+------+---------+----------------+-----------+-------------+---------------------+

Total database accesses: 98, total allocated memory: 2728
...
| Operator           | Details                                   | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+--------------------+-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults    | `other.name`                              |             13 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection        | cache[other.name] AS `other.name`         |             13 |   14 |      14 |               1 |                 0 |               1.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SelectOrSemiApply | anon_27                                   |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |\                 +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter          | anon_87:Location                          |             15 |    0 |      12 |               0 |                 0 |               0.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)     | (other)-[anon_73:WORKS_IN]->(anon_87)     |             15 |   12 |      26 |              12 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument        | other                                     |             14 |   12 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +LetSemiApply      |                                           |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |\                 +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +CacheProperties | cache[other.name]                         |              2 |    0 |       0 |               0 |                 0 |               0.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter          | anon_53:Person                            |              2 |    0 |       2 |               1 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)     | (other)-[anon_35:FRIENDS_WITH]->(anon_53) |              2 |    2 |      33 |              15 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument        | other                                     |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan   | other:Person                              |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
+--------------------+-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| Operator           | Details                                   | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+--------------------+-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults    | `other.name`                              |             11 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection        | other.name AS `other.name`                |             11 |   14 |      14 |               1 |                 0 |               1.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SelectOrSemiApply | anon_32                                   |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |\                 +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter          | anon_93:Location                          |             15 |    0 |       2 |               0 |                 0 |               0.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)     | (other)-[anon_79:WORKS_IN]->(anon_93)     |             15 |    2 |       7 |               2 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument        | other                                     |             14 |    2 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +LetAntiSemiApply  |                                           |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |\                 +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter          | anon_58:Person                            |              2 |    0 |       2 |               1 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)     | (other)-[anon_40:FRIENDS_WITH]->(anon_58) |              2 |    2 |      33 |              15 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument        | other                                     |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan   | other:Person                              |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
...
| Operator           | Details                                   | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+--------------------+-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults    | `other.name`                              |             11 |    2 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection        | cache[other.name] AS `other.name`         |             11 |    2 |       2 |               1 |                 0 |               1.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SelectOrSemiApply | other.age > $autoint_0                    |             14 |    2 |      14 |               0 |                 0 |               0.0000 |
| |\                 +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +CacheProperties | cache[other.name]                         |              2 |    0 |       0 |               0 |                 0 |               0.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter          | anon_71:Person                            |              2 |    0 |       2 |               1 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)     | (other)-[anon_53:FRIENDS_WITH]->(anon_71) |              2 |    2 |      33 |              15 |                 0 |               1.0000 |
| | |                +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument        | other                                     |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                  +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan   | other:Person                              |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
...
Total database accesses: 66, total allocated memory: 0
...
| Operator               | Details                                   | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+------------------------+-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults        | `other.name`                              |              4 |   12 |       0 |               0 |                 0 |               0.0000 |
| |                      +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection            | other.name AS `other.name`                |              4 |   12 |      12 |               1 |                 0 |               1.0000 |
| |                      +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SelectOrAntiSemiApply | other.age > $autoint_0                    |             14 |   12 |      14 |               0 |                 0 |               0.0000 |
| |\                     +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter              | anon_75:Person                            |              2 |    0 |       2 |               1 |                 0 |               1.0000 |
| | |                    +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)         | (other)-[anon_57:FRIENDS_WITH]->(anon_75) |              2 |    2 |      33 |              15 |                 0 |               1.0000 |
| | |                    +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument            | other                                     |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                      +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan       | other:Person                              |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
...
Total database accesses: 76, total allocated memory: 0
...
| | +Argument           | other                                     |             14 |   12 |       0 |               0 |                 0 |               0.0000 |
| |                     +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +LetSelectOrSemiApply | other.age = $autoint_0                    |             14 |   14 |      14 |               0 |                 0 |               0.0000 |
| |\                    +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +CacheProperties    | cache[other.name]                         |              2 |    0 |       0 |               0 |                 0 |               0.0000 |
| | |                   +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter             | anon_53:Person                            |              2 |    0 |       2 |               1 |                 0 |               1.0000 |
...
| +Projection               | other.name AS `other.name`                |             11 |   14 |      14 |               1 |                 0 |               1.0000 |
| |                         +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SelectOrSemiApply        | anon_31                                   |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |\                        +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter                 | anon_91:Location                          |             15 |    0 |       2 |               0 |                 0 |               0.0000 |
| | |                       +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)            | (other)-[anon_77:WORKS_IN]->(anon_91)     |             15 |    2 |       7 |               2 |                 0 |               1.0000 |
| | |                       +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument               | other                                     |             14 |    2 |       0 |               0 |                 0 |               0.0000 |
| |                         +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +LetSelectOrAntiSemiApply | other.age = $autoint_0                    |             14 |   14 |      14 |               0 |                 0 |               0.0000 |
| |\                        +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter                 | anon_57:Person                            |              2 |    0 |       2 |               1 |                 0 |               1.0000 |
| | |                       +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)            | (other)-[anon_39:FRIENDS_WITH]->(anon_57) |              2 |    2 |      33 |              15 |                 0 |               1.0000 |
| | |                       +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument               | other                                     |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                         +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan          | other:Person                              |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
...
| |                     +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +AntiConditionalApply |                                           |              1 |    1 |       0 |               0 |                 0 |               0.0000 |            |
| |\                    +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +MergeCreateNode    | p                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| |                     +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +ConditionalApply     |                                           |              1 |    1 |       0 |               0 |                 0 |               0.0000 |            |
| |\                    +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +SetProperty        | p.exists = true                           |              1 |    1 |       3 |               2 |                 0 |               1.0000 |            |
| | |                   +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +Argument           | p                                         |              1 |    1 |       0 |               0 |                 0 |               0.0000 |            |
| |                     +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +Optional             |                                           |              1 |    1 |       0 |               0 |                 0 |               0.0000 | p.name ASC |
| |                     +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +NodeIndexSeek        | p:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |               0 |                 1 |               0.0000 | p.name ASC |
+-----------------------+-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
...
| +AntiConditionalApply |                                           |              1 |    1 |       0 |               0 |                 0 |               0.0000 |            |
| |\                    +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +SetProperty        | p.exists = true                           |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | |                   +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +MergeCreateNode    | p                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| |                     +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +Optional             |                                           |              1 |    1 |       0 |               0 |                 0 |               0.0000 | p.name ASC |
...
| Operator         | Details                            | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+------------------+------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults  | `p.name`, cities                   |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                +------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection      | p.name AS `p.name`                 |             14 |   14 |      14 |               0 |                 0 |               0.0000 |
| |                +------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +RollUpApply     | cities, anon_32                    |             14 |   14 |       0 |               0 |                 0 |               0.0000 |
| |\               +------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Projection    | location.name AS anon_32           |              0 |   15 |      15 |               2 |                 0 |               1.0000 |
| | |              +------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)   | (p)-[anon_38:WORKS_IN]->(location) |              0 |   15 |      33 |              15 |                 0 |               1.0000 |
| | |              +------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument      | p                                  |              1 |   14 |       0 |               0 |                 0 |               0.0000 |
| |                +------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan | p:Person                           |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
+------------------+------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| +EmptyResult                 |                                           |              1 |    0 |       0 |                |               0 |                 0 |               0.0000 |            |
| |                            +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| +Apply                       |                                           |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| |\                           +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | +AntiConditionalApply      |                                           |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| | |\                         +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | | +MergeCreateRelationship | (s)-[anon_40:FRIENDS_WITH]->(s)           |              1 |    1 |       2 |                |               2 |                 0 |               1.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | | +Argument                | s                                         |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| | |                          +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | +AntiConditionalApply      |                                           |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| | |\                         +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | | +Optional                | s                                         |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | | +Expand(Into)            | (s)-[anon_40:FRIENDS_WITH]->(s)           |              0 |    0 |       4 |            856 |               1 |                 0 |               1.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | | +LockNodes               | s                                         |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | | +Argument                | s                                         |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| | |                          +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | +Optional                  | s                                         |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| | |                          +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | +Expand(Into)              | (s)-[anon_40:FRIENDS_WITH]->(s)           |              0 |    0 |       4 |            856 |               2 |                 0 |               1.0000 |            |
| | |                          +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| | +Argument                  | s                                         |              1 |    1 |       0 |                |               0 |                 0 |               0.0000 |            |
| |                            +-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+
| +NodeIndexSeek               | s:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |                |               0 |                 1 |               0.0000 | s.name ASC |
+------------------------------+-------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+------------+

Total database accesses: 12, total allocated memory: 1552
...
| Operator        | Details                                   | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Order      | Other               |
+-----------------+-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +ProduceResults | fof                                       |              0 |    1 |       0 |                | p.name ASC | Fused in Pipeline 0 |
| |               +-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +Expand(All)    | (p)-[anon_30:FRIENDS_WITH]->(fof)         |              0 |    1 |       3 |                | p.name ASC | Fused in Pipeline 0 |
| |               +-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +NodeIndexSeek  | p:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |             64 | p.name ASC | Fused in Pipeline 0 |
+-----------------+-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
...
| Operator        | Details                                   | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Order      | Other               |
+-----------------+-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +ProduceResults | fof                                       |              0 |    0 |       0 |                | p.name ASC | Fused in Pipeline 0 |
| |               +-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +Filter         | not anon_30 = anon_53                     |              0 |    0 |       0 |                | p.name ASC | Fused in Pipeline 0 |
| |               +-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +Expand(Into)   | (p)-[anon_30:FRIENDS_WITH]->(fof)         |              0 |    0 |       0 |              0 | p.name ASC | Fused in Pipeline 0 |
| |               +-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +Expand(All)    | (p)<-[anon_53]-(fof)                      |              0 |    0 |       3 |                | p.name ASC | Fused in Pipeline 0 |
| |               +-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
| +NodeIndexSeek  | p:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |             64 | p.name ASC | Fused in Pipeline 0 |
+-----------------+-------------------------------------------+----------------+------+---------+----------------+------------+---------------------+
...
| Operator             | Details                                                           | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Other               |
+----------------------+-------------------------------------------------------------------+----------------+------+---------+----------------+---------------------+
| +ProduceResults      | p, l                                                              |             14 |   15 |       0 |                | Fused in Pipeline 0 |
| |                    +-------------------------------------------------------------------+----------------+------+---------+----------------+---------------------+
| +OptionalExpand(All) | (p)-[works_in:WORKS_IN]->(l) WHERE works_in.duration > $autoint_0 |             14 |   15 |      48 |                | Fused in Pipeline 0 |
| |                    +-------------------------------------------------------------------+----------------+------+---------+----------------+---------------------+
| +NodeByLabelScan     | p:Person                                                          |             14 |   14 |      15 |             64 | Fused in Pipeline 0 |
+----------------------+-------------------------------------------------------------------+----------------+------+---------+----------------+---------------------+

Total database accesses: 63, total allocated memory: 64
...
| |                     +------------------------------+----------------+------+---------+----------------+---------------------+
| +OptionalExpand(Into) | (l)-[anon_61]->(p)           |             15 |   15 |     105 |           3208 | Fused in Pipeline 0 |
| |                     +------------------------------+----------------+------+---------+----------------+---------------------+
...
Total database accesses: 153, total allocated memory: 3208
...
| |                     +------------------------------------+----------------+------+---------+----------------+---------------------+
| +VarLengthExpand(All) | (p)-[anon_17:FRIENDS_WITH*..2]-(q) |              4 |    6 |      47 |                | Fused in Pipeline 0 |
| |                     +------------------------------------+----------------+------+---------+----------------+---------------------+
| +NodeByLabelScan      | p:Person                           |             14 |   14 |      15 |             64 | Fused in Pipeline 0 |
+-----------------------+------------------------------------+----------------+------+---------+----------------+---------------------+

Total database accesses: 68, total allocated memory: 64
...
| |                      +------------------------------------+----------------+------+---------+----------------+---------------------+
| +VarLengthExpand(Into) | (p)-[anon_17:FRIENDS_WITH*..2]-(p) |              0 |    0 |      47 |                | Fused in Pipeline 0 |
| |                      +------------------------------------+----------------+------+---------+----------------+---------------------+
| +NodeByLabelScan       | p:Person                           |             14 |   14 |      15 |             64 | Fused in Pipeline 0 |
+------------------------+------------------------------------+----------------+------+---------+----------------+---------------------+

Total database accesses: 62, total allocated memory: 64
...
+---------------------------+------------------------------+----------------+------+---------+----------------+-----------+---------------+
| Operator                  | Details                      | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Other         |
+---------------------------+------------------------------+----------------+------+---------+----------------+-----------+---------------+
| +ProduceResults           | p, q                         |              0 |    0 |       0 |                |     0.054 | In Pipeline 1 |
| |                         +------------------------------+----------------+------+---------+----------------+-----------+---------------+
| +Distinct                 | p, q                         |              0 |    0 |       0 |            176 |     1.308 | In Pipeline 1 |
| |                         +------------------------------+----------------+------+---------+----------------+-----------+---------------+
| +Filter                   | q:Person                     |              0 |    0 |       0 |                |     0.082 | In Pipeline 1 |
| |                         +------------------------------+----------------+------+---------+----------------+-----------+---------------+
| +VarLengthExpand(Pruning) | (p)-[:FRIENDS_WITH*3..4]-(q) |              0 |    0 |      32 |            896 |           | In Pipeline 1 |
| |                         +------------------------------+----------------+------+---------+----------------+-----------+---------------+
| +NodeByLabelScan          | p:Person                     |             14 |   14 |      15 |             64 |     0.150 | In Pipeline 0 |
+---------------------------+------------------------------+----------------+------+---------+----------------+-----------+---------------+

Total database accesses: 47, total allocated memory: 1072
...
| +AntiConditionalApply           |                                                |              1 |    1 |       0 |               0 |                 0 |               0.0000 |            |
| |\                              +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +MergeCreateNode              | t                                              |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| |                               +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +Optional                       |                                                |              1 |    1 |       0 |               0 |                 0 |               0.0000 | t.name ASC |
| |                               +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +AssertSameNode                 | t                                              |              0 |    1 |       0 |               0 |                 0 |               0.0000 | t.name ASC |
| |\                              +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +NodeUniqueIndexSeek(Locking) | UNIQUE t:Team(id) WHERE id = $autoint_1        |              1 |    1 |       1 |               0 |                 1 |               0.0000 | t.id ASC   |
| |                               +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +NodeUniqueIndexSeek(Locking)   | UNIQUE t:Team(name) WHERE name = $autostring_0 |              1 |    1 |       1 |               0 |                 1 |               0.0000 | t.name ASC |
+---------------------------------+------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
...
| Operator        | Details | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+-----------------+---------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults | p       |              0 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +---------+----------------+------+---------+-----------------+-------------------+----------------------+
| +DropResult     |         |              0 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +---------+----------------+------+---------+-----------------+-------------------+----------------------+
| +AllNodesScan   | p       |             35 |    0 |       0 |               0 |                 0 |               0.0000 |
+-----------------+---------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| +EmptyResult    |                 |              1 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +-----------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Create         | (anon_8:Person) |              1 |    1 |       1 |               0 |                 0 |               0.0000 |
+-----------------+-----------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| Operator        | Details | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+-----------------+---------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults | line    |              1 |    4 |       0 |               0 |                 0 |               0.0000 |
| |               +---------+----------------+------+---------+-----------------+-------------------+----------------------+
| +LoadCSV        | line    |              1 |    4 |       0 |               0 |                 0 |               0.0000 |
+-----------------+---------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| Operator         | Details                                      | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order         | Other               |
+------------------+----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| +ProduceResults  | `loc.name`                                   |             10 |    0 |       0 |                |     0.000 | matt.name ASC | In Pipeline 2       |
| |                +----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| +Projection      | loc.name AS `loc.name`                       |             10 |    0 |       0 |                |     0.000 | matt.name ASC | In Pipeline 2       |
| |                +----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| +Filter          | not anon_32 = anon_51                        |             10 |    0 |       0 |                |     0.000 | matt.name ASC | In Pipeline 2       |
| |                +----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| +NodeHashJoin    | loc                                          |             10 |    0 |       0 |            472 |     0.103 | matt.name ASC | In Pipeline 2       |
| |\               +----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| | +Expand(All)   | (matt)-[anon_51:WORKS_IN]->(loc)             |             19 |    0 |       0 |                |           | matt.name ASC | Fused in Pipeline 1 |
| | |              +----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| | +NodeIndexSeek | matt:Person(name) WHERE name = $autostring_1 |              1 |    0 |       1 |             64 |           | matt.name ASC | Fused in Pipeline 1 |
| |                +----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| +Expand(All)     | (bob)-[anon_32:WORKS_IN]->(loc)              |             19 |    1 |       3 |                |           | bob.name ASC  | Fused in Pipeline 0 |
| |                +----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+
| +NodeIndexSeek   | bob:Person(name) WHERE name = $autostring_0  |              1 |    1 |       2 |             64 |           | bob.name ASC  | Fused in Pipeline 0 |
+------------------+----------------------------------------------+----------------+------+---------+----------------+-----------+---------------+---------------------+

Total database accesses: 6, total allocated memory: 536
...
| Operator           | Details       | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Other         |
+--------------------+---------------+----------------+------+---------+----------------+-----------+---------------+
| +ProduceResults    | p, q          |              0 |    0 |       0 |                |     0.040 | In Pipeline 2 |
| |                  +---------------+----------------+------+---------+----------------+-----------+---------------+
| +ValueHashJoin     | p.age = q.age |              0 |    0 |       0 |            408 |     1.023 | In Pipeline 2 |
| |\                 +---------------+----------------+------+---------+----------------+-----------+---------------+
| | +NodeByLabelScan | q:Person      |             14 |   14 |      15 |             64 |     0.130 | In Pipeline 1 |
| |                  +---------------+----------------+------+---------+----------------+-----------+---------------+
| +NodeByLabelScan   | p:Person      |             14 |   14 |      15 |             64 |     0.375 | In Pipeline 0 |
+--------------------+---------------+----------------+------+---------+----------------+-----------+---------------+

Total database accesses: 30, total allocated memory: 408
...
+-------------------------+------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +ProduceResults         | `a.name`, `b.name`                                   |             14 |   14 |       0 |                |               0 |                 0 |               0.0000 |
| |                       +------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Projection             | cache[a.name] AS `a.name`, cache[b.name] AS `b.name` |             14 |   14 |      12 |                |               0 |                 0 |               0.0000 |
| |                       +------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +NodeRightOuterHashJoin | a                                                    |             14 |   14 |       0 |           1112 |               0 |                 0 |               0.0000 |
| |\                      +------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| | +NodeByLabelScan      | a:Person                                             |             14 |   14 |      15 |                |               2 |                 0 |               1.0000 |
| |                       +------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +CacheProperties        | cache[a.name], cache[b.name]                         |              2 |    2 |       4 |                |               2 |                 0 |               1.0000 |
| |                       +------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Expand(All)            | (b)<-[anon_36]-(a)                                   |              2 |    2 |      33 |                |              15 |                 0 |               1.0000 |
| |                       +------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +NodeByLabelScan        | b:Person                                             |             14 |   14 |      15 |                |               2 |                 0 |               1.0000 |
+-------------------------+------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+

Total database accesses: 79, total allocated memory: 1112
...
| Operator          | Details                                  | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+-------------------+------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults   | `other.name`                             |              0 |    2 |       0 |               0 |                 0 |               0.0000 |
| |                 +------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection       | other.name AS `other.name`               |              0 |    2 |       2 |               2 |                 0 |               1.0000 |
| |                 +------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +TriadicSelection | WHERE NOT (me)--(other)                  |              0 |    2 |       0 |               0 |                 0 |               0.0000 |
| |\                +------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Filter         | not anon_18 = anon_37                    |              0 |    2 |       0 |               0 |                 0 |               0.0000 |
| | |               +------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Expand(All)    | (anon_35)-[anon_37:FRIENDS_WITH]-(other) |              0 |    6 |      14 |               4 |                 0 |               1.0000 |
| | |               +------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument       | me, anon_18, anon_35                     |              4 |    4 |       0 |               0 |                 0 |               0.0000 |
| |                 +------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Expand(All)      | (me)-[anon_18:FRIENDS_WITH]-(anon_35)    |              4 |    4 |      33 |              15 |                 0 |               1.0000 |
| |                 +------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan  | me:Person                                |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
+-------------------+------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| Operator           | Details  | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Other         |
+--------------------+----------+----------------+------+---------+----------------+-----------+---------------+
| +ProduceResults    | p, t     |            140 |  140 |       0 |                |     3.885 | In Pipeline 2 |
| |                  +----------+----------------+------+---------+----------------+-----------+---------------+
| +CartesianProduct  |          |            140 |  140 |       0 |            280 |     1.202 | In Pipeline 2 |
| |\                 +----------+----------------+------+---------+----------------+-----------+---------------+
| | +NodeByLabelScan | p:Person |             14 |   14 |      15 |             80 |     0.053 | In Pipeline 1 |
| |                  +----------+----------------+------+---------+----------------+-----------+---------------+
| +NodeByLabelScan   | t:Team   |             10 |   10 |      11 |             64 |     0.135 | In Pipeline 0 |
+--------------------+----------+----------------+------+---------+----------------+-----------+---------------+

Total database accesses: 26, total allocated memory: 280
...
| +EmptyResult    |                    |              1 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +--------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Foreach        | value IN [1, 2, 3] |              1 |    1 |       0 |               0 |                 0 |               0.0000 |
| |\              +--------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Create       | (anon_36:Person)   |              1 |    3 |       9 |               0 |                 0 |               0.0000 |
| | |             +--------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument     | value              |              1 |    3 |       0 |               0 |                 0 |               0.0000 |
| |               +--------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| +EmptyResult            |             |              1 |    0 |       0 |                |               0 |                 0 |               0.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Apply                  |             |              1 |  504 |       0 |                |               0 |                 0 |               0.0000 |
| |\                      +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| | +AntiConditionalApply |             |              1 |  504 |       0 |                |               0 |                 0 |               0.0000 |
| | |\                    +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| | | +MergeCreateNode    | anon_38     |              1 |    0 |       0 |                |               0 |                 0 |               0.0000 |
| | |                     +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| | +Optional             |             |             35 |  504 |       0 |                |               0 |                 0 |               0.0000 |
| | |                     +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| | +AllNodesScan         | anon_38     |             35 |  504 |     540 |                |               0 |                 0 |               0.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Eager                  |             |             36 |   36 |       0 |           7432 |               0 |                 0 |               0.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Delete                 | b           |             36 |   36 |       9 |                |               0 |                 0 |               0.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Delete                 | a           |             36 |   36 |      12 |                |               1 |                 0 |               1.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Delete                 | r           |             36 |   36 |      18 |                |              19 |                 0 |               1.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Eager                  |             |             36 |   36 |       0 |           7432 |               0 |                 0 |               0.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +Expand(All)            | (a)-[r]-(b) |             36 |   36 |      71 |                |              22 |                 0 |               1.0000 |
| |                       +-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+
| +AllNodesScan           | a           |             35 |   35 |      36 |                |               1 |                 0 |               1.0000 |
+-------------------------+-------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+

Total database accesses: 686, total allocated memory: 14776
...
| Operator          | Details                                              | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Other               |
+-------------------+------------------------------------------------------+----------------+------+---------+----------------+-----------+---------------------+
| +ProduceResults   | location, people                                     |              4 |    6 |       0 |                |     0.349 | In Pipeline 1       |
| |                 +------------------------------------------------------+----------------+------+---------+----------------+-----------+---------------------+
| +EagerAggregation | cache[l.name] AS location, collect(p.name) AS people |              4 |    6 |      30 |           2388 |     0.199 | Fused in Pipeline 0 |
| |                 +------------------------------------------------------+----------------+------+---------+----------------+-----------+---------------------+
...
| |                 +------------------------------------------------------+----------------+------+---------+----------------+-----------+---------------------+
| +NodeByLabelScan  | l:Location                                           |             10 |   10 |      11 |             64 |           | Fused in Pipeline 0 |
+-------------------+------------------------------------------------------+----------------+------+---------+----------------+-----------+---------------------+

Total database accesses: 102, total allocated memory: 2388
...
| Operator              | Details                                                            | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order      | Other         |
+-----------------------+--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +ProduceResults       | `p.name`, count                                                    |              0 |    2 |       0 |                |     0.191 | p.name ASC | In Pipeline 1 |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +OrderedAggregation   | cache[p.name] AS `p.name`, count(*) AS count                       |              0 |    2 |       0 |            200 |     0.539 | p.name ASC | In Pipeline 1 |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +NodeIndexSeekByRange | p:Person(name) WHERE name STARTS WITH $autostring_0, cache[p.name] |              0 |    2 |       3 |             64 |     1.596 | p.name ASC | In Pipeline 0 |
+-----------------------+--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+

Total database accesses: 3, total allocated memory: 200
...
| |                        +------------------------------+----------------+------+---------+----------------+---------------------+
| +NodeCountFromCountStore | count( (:Person) ) AS people |              1 |    1 |       1 |             64 | Fused in Pipeline 0 |
+--------------------------+------------------------------+----------------+------+---------+----------------+---------------------+
...
| |                                +--------------------------------------------+----------------+------+---------+----------------+---------------------+
| +RelationshipCountFromCountStore | count( (:Person)-[:WORKS_IN]->() ) AS jobs |              1 |    1 |       1 |             64 | Fused in Pipeline 0 |
+----------------------------------+--------------------------------------------+----------------+------+---------+----------------+---------------------+
...
| Operator              | Details                                                            | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order      | Other         |
+-----------------------+--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +ProduceResults       | `p.name`                                                           |              0 |    2 |       0 |                |     0.133 | p.name ASC | In Pipeline 0 |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +OrderedDistinct      | cache[p.name] AS `p.name`                                          |              0 |    2 |       0 |                |     0.983 | p.name ASC | In Pipeline 0 |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +NodeIndexSeekByRange | p:Person(name) WHERE name STARTS WITH $autostring_0, cache[p.name] |              0 |    2 |       3 |             64 |     0.296 | p.name ASC | In Pipeline 0 |
+-----------------------+--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
...
| |               +--------------------------------------------------+----------------+------+---------+----------------+---------------------+
| +NodeIndexScan  | p:Person(name) WHERE exists(name), cache[p.name] |             14 |   14 |      15 |             64 | Fused in Pipeline 0 |
+-----------------+--------------------------------------------------+----------------+------+---------+----------------+---------------------+
...
| |                +----------+----------------+------+---------+----------------+---------------------+
| +NodeByLabelScan | p:Person |             14 |    4 |       5 |             64 | Fused in Pipeline 0 |
+------------------+----------+----------------+------+---------+----------------+---------------------+
...
| Operator         | Details        | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order    | Other               |
+------------------+----------------+----------------+------+---------+----------------+-----------+----------+---------------------+
| +ProduceResults  | p              |             14 |   13 |       0 |                |     0.727 | p.id ASC | In Pipeline 1       |
| |                +----------------+----------------+------+---------+----------------+-----------+----------+---------------------+
| +Skip            | $autoint_0     |             14 |   13 |       0 |                |     0.777 | p.id ASC | In Pipeline 1       |
| |                +----------------+----------------+------+---------+----------------+-----------+----------+---------------------+
| +Sort            | `p.id` ASC     |             14 |   14 |       0 |            344 |     0.261 | p.id ASC | In Pipeline 1       |
| |                +----------------+----------------+------+---------+----------------+-----------+----------+---------------------+
...
Total database accesses: 43, total allocated memory: 344
...
| Operator         | Details            | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order      | Other               |
+------------------+--------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +ProduceResults  | p                  |             14 |   14 |       0 |                |     0.458 | p.name ASC | In Pipeline 1       |
| |                +--------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +Sort            | `p.name` ASC       |             14 |   14 |       0 |           1136 |     0.300 | p.name ASC | In Pipeline 1       |
| |                +--------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
...
Total database accesses: 43, total allocated memory: 1136
...
| Operator              | Details                                                            | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order                 | Other               |
+-----------------------+--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +ProduceResults       | p                                                                  |              0 |    2 |       0 |                |     0.282 | p.name ASC, p.age ASC | In Pipeline 1       |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +PartialSort          | `p.name` ASC, `p.age` ASC                                          |              0 |    2 |       0 |            600 |     1.491 | p.name ASC, p.age ASC | In Pipeline 1       |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +Projection           | cache[p.name] AS `p.name`, p.age AS `p.age`                        |              0 |    2 |       0 |                |           | p.name ASC            | Fused in Pipeline 0 |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +NodeIndexSeekByRange | p:Person(name) WHERE name STARTS WITH $autostring_0, cache[p.name] |              0 |    2 |       3 |             64 |           | p.name ASC            | Fused in Pipeline 0 |
+-----------------------+--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
...
| Operator         | Details              | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order      | Other               |
+------------------+----------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +ProduceResults  | p                    |              2 |    2 |       0 |                |     0.269 | p.name ASC | In Pipeline 1       |
| |                +----------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +Top             | `p.name` ASC LIMIT 2 |              2 |    2 |       0 |           1088 |     1.133 | p.name ASC | In Pipeline 1       |
| |                +----------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +Projection      | p.name AS `p.name`   |             14 |   14 |      28 |                |           |            | Fused in Pipeline 0 |
| |                +----------------------+----------------+------+---------+----------------+-----------+------------+---------------------+
| +NodeByLabelScan | p:Person             |             14 |   14 |      15 |             64 |           |            | Fused in Pipeline 0 |
...
Total database accesses: 43, total allocated memory: 1088
...
| Operator              | Details                                                            | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order                 | Other               |
+-----------------------+--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +ProduceResults       | p                                                                  |              0 |    2 |       0 |                |     0.193 | p.name ASC, p.age ASC | In Pipeline 1       |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +PartialTop           | `p.name` ASC, `p.age` ASC LIMIT 2                                  |              0 |    2 |       0 |            344 |     0.965 | p.name ASC, p.age ASC | In Pipeline 1       |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +Projection           | cache[p.name] AS `p.name`, p.age AS `p.age`                        |              0 |    2 |       0 |                |           | p.name ASC            | Fused in Pipeline 0 |
| |                     +--------------------------------------------------------------------+----------------+------+---------+----------------+-----------+-----------------------+---------------------+
| +NodeIndexSeekByRange | p:Person(name) WHERE name STARTS WITH $autostring_0, cache[p.name] |              0 |    2 |       3 |             64 |           | p.name ASC            | Fused in Pipeline 0 |
...
| |                  +--------------------+----------------+------+---------+----------------+---------------------+
| +Union             |                    |             20 |   11 |       0 |            760 | Fused in Pipeline 2 |
| |\                 +--------------------+----------------+------+---------+----------------+---------------------+
| | +Projection      | `p.name`           |             10 |    1 |       0 |                | Fused in Pipeline 1 |
| | |                +--------------------+----------------+------+---------+----------------+---------------------+
| | +Projection      | p.name AS `p.name` |             10 |    1 |       2 |                | Fused in Pipeline 1 |
| | |                +--------------------+----------------+------+---------+----------------+---------------------+
| | +NodeByLabelScan | p:Country          |             10 |    1 |       2 |             64 | Fused in Pipeline 1 |
| |                  +--------------------+----------------+------+---------+----------------+---------------------+
| +Projection        | `p.name`           |             10 |   10 |       0 |                | Fused in Pipeline 0 |
| |                  +--------------------+----------------+------+---------+----------------+---------------------+
| +Projection        | p.name AS `p.name` |             10 |   10 |      20 |                | Fused in Pipeline 0 |
| |                  +--------------------+----------------+------+---------+----------------+---------------------+
| +NodeByLabelScan   | p:Location         |             10 |   10 |      11 |             64 | Fused in Pipeline 0 |
+--------------------+--------------------+----------------+------+---------+----------------+---------------------+

Total database accesses: 35, total allocated memory: 824
...
| Operator         | Details                                   | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order      | Other         |
+------------------+-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +ProduceResults  | p, q                                      |              1 |    1 |       0 |                |     0.377 | p.name ASC | In Pipeline 2 |
| |                +-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +Apply           |                                           |              1 |    1 |       0 |                |     0.802 | p.name ASC |               |
| |\               +-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| | +Optional      | p                                         |              1 |    1 |       0 |              0 |     0.683 | q.name ASC | In Pipeline 2 |
| | |              +-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| | +NodeIndexSeek | q:Person(name) WHERE name = $autostring_1 |              1 |    0 |       1 |             72 |     0.247 | q.name ASC | In Pipeline 1 |
| |                +-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
| +NodeIndexSeek   | p:Person(name) WHERE name = $autostring_0 |              1 |    1 |       2 |             64 |     5.674 | p.name ASC | In Pipeline 0 |
+------------------+-------------------------------------------+----------------+------+---------+----------------+-----------+------------+---------------+
...
| Operator            | Details                      | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+---------------------+------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults     | u, v                         |             18 |    1 |       0 |               0 |                 0 |               0.0000 |
| |                   +------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Apply              |                              |             18 |    1 |       0 |               0 |                 0 |               0.0000 |
| |\                  +------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +ProjectEndpoints | (u)-[r*]->(v)                |             18 |    1 |       0 |               0 |                 0 |               0.0000 |
| | |                 +------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| | +Argument         | r                            |              1 |    1 |       0 |               0 |                 0 |               0.0000 |
| |                   +------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Projection         | p AS r                       |              1 |    1 |       0 |               0 |                 0 |               0.0000 |
| |                   +------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Create             | (n), (m), (n)-[p:KNOWS]->(m) |              1 |    1 |       4 |               0 |                 0 |               0.0000 |
+---------------------+------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| Operator        | Details                           | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Time (ms) | Order     | Other         |
+-----------------+-----------------------------------+----------------+------+---------+----------------+-----------+-----------+---------------+
| +ProduceResults | label                             |          10000 |    4 |       0 |                |     0.177 | label ASC | In Pipeline 2 |
| |               +-----------------------------------+----------------+------+---------+----------------+-----------+-----------+---------------+
| +Sort           | label ASC                         |          10000 |    4 |       0 |            480 |     4.487 | label ASC | In Pipeline 2 |
| |               +-----------------------------------+----------------+------+---------+----------------+-----------+-----------+---------------+
| +ProcedureCall  | db.labels() :: (label :: STRING?) |          10000 |    4 |         |             56 |           |           | In Pipeline 1 |
+-----------------+-----------------------------------+----------------+------+---------+----------------+-----------+-----------+---------------+

Total database accesses: ?, total allocated memory: 480
...
Total database accesses: 102, total allocated memory: 64
...
| +EmptyResult    |                                                                     |              1 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +---------------------------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Create         | (max:Person), (chris:Person), (max)-[anon_79:FRIENDS_WITH]->(chris) |              1 |    1 |       8 |               0 |                 0 |               0.0000 |
+-----------------+---------------------------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| Operator        | Details                                                                     | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio | Order       |
+-----------------+-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +ProduceResults |                                                                             |              0 |    0 |       0 |                |               0 |                 0 |               0.0000 |             |
| |               +-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +EmptyResult    |                                                                             |              0 |    0 |       0 |                |               0 |                 0 |               0.0000 |             |
| |               +-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +Delete         | w                                                                           |              0 |    1 |       1 |                |               2 |                 0 |               1.0000 |             |
| |               +-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +Eager          |                                                                             |              0 |    1 |       0 |           4352 |               0 |                 0 |               0.0000 | me.name ASC |
| |               +-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +Filter         | london.name = $autostring_2 AND london:Location AND w.duration = $autoint_1 |              0 |    1 |       3 |                |               3 |                 0 |               1.0000 | me.name ASC |
| |               +-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +Expand(All)    | (me)-[w:WORKS_IN]->(london)                                                 |              1 |    1 |       3 |                |               2 |                 0 |               1.0000 | me.name ASC |
| |               +-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+
| +NodeIndexSeek  | me:Person(name) WHERE name = $autostring_0                                  |              1 |    1 |       2 |                |               0 |                 1 |               0.0000 | me.name ASC |
+-----------------+-----------------------------------------------------------------------------+----------------+------+---------+----------------+-----------------+-------------------+----------------------+-------------+

Total database accesses: 9, total allocated memory: 4352
...
| Operator         | Details  | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+------------------+----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults  |          |             14 |    0 |       0 |               0 |                 0 |               0.0000 |
| |                +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +EmptyResult     |          |             14 |    0 |       0 |               0 |                 0 |               0.0000 |
| |                +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +DetachDelete    | p        |             14 |   14 |       0 |              48 |                 0 |               1.0000 |
| |                +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +NodeByLabelScan | p:Person |             14 |   14 |      15 |               2 |                 0 |               1.0000 |
+------------------+----------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| +AntiConditionalApply |                                                |              1 |    1 |       0 |               0 |                 0 |               0.0000 |                 |
| |\                    +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+-----------------+
| | +MergeCreateNode    | anon_7                                         |              1 |    1 |       3 |               0 |                 0 |               0.0000 |                 |
| |                     +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+-----------------+
| +Optional             |                                                |              1 |    1 |       0 |               0 |                 0 |               0.0000 | anon_7.name ASC |
| |                     +------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+-----------------+
| +NodeIndexSeek        | anon_7:Person(name) WHERE name = $autostring_0 |              1 |    0 |       1 |               0 |                 1 |               0.0000 | anon_7.name ASC |
+-----------------------+------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+-----------------+
...
| +EmptyResult                 |                                           |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| |                            +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +Apply                       |                                           |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| |\                           +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +AntiConditionalApply      |                                           |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | |\                         +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | | +MergeCreateRelationship | (s)-[anon_43:FRIENDS_WITH]->(s)           |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | | +Argument                | s                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | |                          +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +AntiConditionalApply      |                                           |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | |\                         +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | | +Optional                | s                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | | +Expand(Into)            | (s)-[anon_43:FRIENDS_WITH]->(s)           |              0 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | | +LockNodes               | s                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | | |                        +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | | +Argument                | s                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| | |                          +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| | +Optional                  | s                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
...
| | +Argument                  | s                                         |              1 |    0 |       0 |               0 |                 0 |               0.0000 |            |
| |                            +-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
| +NodeIndexSeek               | s:Person(name) WHERE name = $autostring_0 |              1 |    0 |       1 |               0 |                 1 |               0.0000 | s.name ASC |
+------------------------------+-------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------+
...
| Operator        | Details  | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+-----------------+----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults |          |             35 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +EmptyResult    |          |             35 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SetLabels      | n:Person |             35 |   35 |      35 |               2 |                 0 |               1.0000 |
| |               +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +AllNodesScan   | n        |             35 |   35 |      36 |               1 |                 0 |               1.0000 |
+-----------------+----------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| +EmptyResult    |          |             35 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +RemoveLabels   | n:Person |             35 |   35 |      35 |               2 |                 0 |               1.0000 |
| |               +----------+----------------+------+---------+-----------------+-------------------+----------------------+
| +AllNodesScan   | n        |             35 |   35 |      36 |               1 |                 0 |               1.0000 |
+-----------------+----------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| +EmptyResult              |                                                   |             35 |    0 |       0 |               0 |                 0 |               0.0000 |
| |                         +---------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SetNodePropertiesFromMap | n = {weekday: $autostring_0, meal: $autostring_1} |             35 |   35 |     141 |               4 |                 0 |               1.0000 |
| |                         +---------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +AllNodesScan             | n                                                 |             35 |   35 |      36 |               1 |                 0 |               1.0000 |
+---------------------------+---------------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| Operator                          | Details                                       | Estimated Rows | Rows | DB Hits | Page Cache Hits | Page Cache Misses | Page Cache Hit Ratio |
+-----------------------------------+-----------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +ProduceResults                   |                                               |             18 |    0 |       0 |               0 |                 0 |               0.0000 |
| |                                 +-----------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +EmptyResult                      |                                               |             18 |    0 |       0 |               0 |                 0 |               0.0000 |
| |                                 +-----------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SetRelationshipPropertiesFromMap | r = {weight: $autoint_0, unit: $autostring_1} |             18 |   18 |      69 |               4 |                 0 |               1.0000 |
| |                                 +-----------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +Expand(All)                      | (m)<-[r]-(n)                                  |             18 |   18 |      71 |              22 |                 0 |               1.0000 |
| |                                 +-----------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +AllNodesScan                     | m                                             |             35 |   35 |      36 |               1 |                 0 |               1.0000 |
+-----------------------------------+-----------------------------------------------+----------------+------+---------+-----------------+-------------------+----------------------+
...
| +EmptyResult    |                  |             35 |    0 |       0 |               0 |                 0 |               0.0000 |
| |               +------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +SetProperty    | n.checked = true |             35 |   35 |      38 |               2 |                 0 |               1.0000 |
| |               +------------------+----------------+------+---------+-----------------+-------------------+----------------------+
| +AllNodesScan   | n                |             35 |   35 |      36 |               1 |                 0 |               1.0000 |
+-----------------+------------------+----------------+------+---------+-----------------+-------------------+----------------------+
