...
+--------------------+----+-----------------------------------------+----------------+------+---------+------------------------+
| +ProduceResults    |  0 | `other.name`                            |             11 |   14 |       0 |                    0/0 |
| |                  +----+-----------------------------------------+----------------+------+---------+------------------------+
| +Projection        |  1 | other.name AS `other.name`              |             11 |   14 |      14 |                    1/0 |
| |                  +----+-----------------------------------------+----------------+------+---------+------------------------+
| +SelectOrSemiApply |  2 | anon_6                                  |             14 |   14 |       0 |                    0/0 |
| |\                 +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Filter          |  3 | anon_3:Location                         |             14 |    0 |      10 |                    0/0 |
| | |                +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Expand(All)     |  4 | (other)-[anon_2:WORKS_IN]->(anon_3)     |             14 |   10 |      38 |                   20/0 |
| | |                +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Argument        |  5 | other                                   |             14 |   10 |       0 |                    0/0 |
| |                  +----+-----------------------------------------+----------------+------+---------+------------------------+
| +LetAntiSemiApply  |  6 |                                         |             14 |   14 |       0 |                    0/0 |
| |\                 +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Filter          |  7 | anon_1:Person                           |             12 |    0 |      10 |                    1/0 |
| | |                +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Expand(All)     |  8 | (other)-[anon_0:FRIENDS_WITH]->(anon_1) |             12 |   10 |      51 |                   28/0 |
| | |                +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Argument        |  9 | other                                   |             14 |   14 |       0 |                    0/0 |
| |                  +----+-----------------------------------------+----------------+------+---------+------------------------+
| +NodeByLabelScan   | 10 | other:Person                            |             14 |   14 |      15 |                    1/0 |
+--------------------+----+-----------------------------------------+----------------+------+---------+------------------------+

Total database accesses: 138, total allocated memory: 64
----
...
| Operator               | Id | Details                                 | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Page Cache Hits/Misses | Time (ms) | Pipeline            |
+------------------------+----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| +ProduceResults        |  0 | `other.name`                            |              9 |    4 |       0 |                |                        |           |                     |
| |                      +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +Projection            |  1 | other.name AS `other.name`              |              9 |    4 |       8 |                |                        |           |                     |
| |                      +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +SelectOrAntiSemiApply |  2 | other.age > $autoint_0                  |             14 |    4 |       0 |            200 |                    0/0 |     0,095 | Fused in Pipeline 3 |
| |\                     +----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| | +Anti                |  8 |                                         |             14 |    4 |       0 |           1256 |                    0/0 |     0,929 | In Pipeline 2       |
| | |                    +----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| | +Limit               |  7 | 1                                       |              0 |   10 |       0 |            752 |                        |           |                     |
| | |                    +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| | +Filter              |  3 | anon_1:Person                           |             12 |   10 |      20 |                |                        |           |                     |
| | |                    +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| | +Expand(All)         |  4 | (other)-[anon_0:FRIENDS_WITH]->(anon_1) |             12 |   10 |      39 |                |                        |           |                     |
| | |                    +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| | +Argument            |  5 | other                                   |             14 |   14 |       0 |           2168 |                    2/0 |     0,753 | Fused in Pipeline 1 |
| |                      +----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| +NodeByLabelScan       |  6 | other:Person                            |             14 |   14 |      15 |            120 |                    1/0 |     0,987 | In Pipeline 0       |
+------------------------+----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+

Total database accesses: 82, total allocated memory: 4208
----
...
| +Projection            |  1 | other.name AS `other.name`              |              9 |    4 |       8 |                |                        |           |                     |
| |                      +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +SelectOrAntiSemiApply |  2 | other.age > $autoint_0                  |             14 |    4 |       0 |            200 |                    0/0 |     0,092 | Fused in Pipeline 3 |
| |\                     +----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| | +Anti                |  8 |                                         |             14 |    4 |       0 |           1256 |                    0/0 |     0,180 | In Pipeline 2       |
| | |                    +----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| | +Limit               |  7 | 1                                       |              0 |   10 |       0 |            752 |                        |           |                     |
| | |                    +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| | +Filter              |  3 | anon_1:Person                           |             12 |   10 |      20 |                |                        |           |                     |
...
| | +Expand(All)         |  4 | (other)-[anon_0:FRIENDS_WITH]->(anon_1) |             12 |   10 |      39 |                |                        |           |                     |
| | |                    +----+-----------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| | +Argument            |  5 | other                                   |             14 |   14 |       0 |           2168 |                    2/0 |     0,151 | Fused in Pipeline 1 |
| |                      +----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| +NodeByLabelScan       |  6 | other:Person                            |             14 |   14 |      15 |            120 |                    1/0 |     0,368 | In Pipeline 0       |
+------------------------+----+-----------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
...
| +ProduceResults       |  0 | `other.name`                            |             11 |   14 |       0 |                    0/0 |
| |                     +----+-----------------------------------------+----------------+------+---------+------------------------+
| +Projection           |  1 | other.name AS `other.name`              |             11 |   14 |      14 |                    0/0 |
| |                     +----+-----------------------------------------+----------------+------+---------+------------------------+
| +SelectOrSemiApply    |  2 | anon_6                                  |             14 |   14 |       0 |                    0/0 |
| |\                    +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Filter             |  3 | anon_3:Location                         |             14 |    0 |       4 |                    0/0 |
| | |                   +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Expand(All)        |  4 | (other)-[anon_2:WORKS_IN]->(anon_3)     |             14 |    4 |      14 |                    8/0 |
| | |                   +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Argument           |  5 | other                                   |             14 |    4 |       0 |                    0/0 |
| |                     +----+-----------------------------------------+----------------+------+---------+------------------------+
| +LetSelectOrSemiApply |  6 | other.age = $autoint_0                  |             14 |   14 |      14 |                    2/0 |
| |\                    +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Filter             |  7 | anon_1:Person                           |             12 |    0 |      10 |                    0/0 |
| | |                   +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Expand(All)        |  8 | (other)-[anon_0:FRIENDS_WITH]->(anon_1) |             12 |   10 |      51 |                   28/0 |
| | |                   +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Argument           |  9 | other                                   |             14 |   14 |       0 |                    0/0 |
...
Total database accesses: 122, total allocated memory: 64
----
...
| | +Argument               |  5 | other                                   |             14 |   10 |       0 |                    0/0 |
| |                         +----+-----------------------------------------+----------------+------+---------+------------------------+
| +LetSelectOrAntiSemiApply |  6 | other.age = $autoint_0                  |             14 |   14 |      14 |                    2/0 |
| |\                        +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Filter                 |  7 | anon_1:Person                           |             12 |    0 |      10 |                    0/0 |
| | |                       +----+-----------------------------------------+----------------+------+---------+------------------------+
| | +Expand(All)            |  8 | (other)-[anon_0:FRIENDS_WITH]->(anon_1) |             12 |   10 |      51 |                   28/0 |
...
Total database accesses: 152, total allocated memory: 64
----
...
| Operator         | Id | Details                           | Estimated Rows | Rows | DB Hits | Page Cache Hits/Misses |
+------------------+----+-----------------------------------+----------------+------+---------+------------------------+
| +ProduceResults  |  0 | `p.name`, cities                  |             14 |   14 |       0 |                    0/0 |
| |                +----+-----------------------------------+----------------+------+---------+------------------------+
| +Projection      |  1 | p.name AS `p.name`                |             14 |   14 |      14 |                    0/0 |
| |                +----+-----------------------------------+----------------+------+---------+------------------------+
| +RollUpApply     |  2 | cities, anon_1                    |             14 |   14 |       0 |                    0/0 |
| |\               +----+-----------------------------------+----------------+------+---------+------------------------+
| | +Projection    |  3 | location.name AS anon_1           |             15 |   15 |      15 |                    2/0 |
| | |              +----+-----------------------------------+----------------+------+---------+------------------------+
| | +Expand(All)   |  4 | (p)-[anon_0:WORKS_IN]->(location) |             15 |   15 |      54 |                   28/0 |
| | |              +----+-----------------------------------+----------------+------+---------+------------------------+
| | +Argument      |  5 | p                                 |             14 |   14 |       0 |                    0/0 |
| |                +----+-----------------------------------+----------------+------+---------+------------------------+
| +NodeByLabelScan |  6 | p:Person                          |             14 |   14 |      15 |                    1/0 |
+------------------+----+-----------------------------------+----------------+------+---------+------------------------+

Total database accesses: 98, total allocated memory: 64
----
...
| |                         +------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
| +NodeByLabelScan          | p:Person                     |             14 |   14 |      15 |            120 |                    1/0 |     0,100 | In Pipeline 0       |
+---------------------------+------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
...
| |                             +-----------------------------+----------------+------+---------+----------------+                        |           |                     |
| +NodeByLabelScan              | p:Person                    |             14 |   14 |      15 |            120 |                    4/0 |     3,202 | Fused in Pipeline 0 |
+-------------------------------+-----------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
...
| |                 +------------------------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +NodeByLabelScan  | l:Location                                           |             10 |   10 |      11 |            120 |                    5/0 |     3,077 | Fused in Pipeline 0 |
+-------------------+------------------------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
...
| +Expand(All)     | (l)<-[anon_0:WORKS_IN]-(p) |             15 |   15 |      16 |                |                        |           |                     |
| |                +----------------------------+----------------+------+---------+----------------+                        |           |                     |
| +NodeByLabelScan | l:Location                 |             10 |   10 |      11 |            120 |                    4/0 |     0,744 | Fused in Pipeline 0 |
+------------------+----------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
...
| Operator         | Details            | Estimated Rows | Rows | DB Hits | Memory (Bytes) | Page Cache Hits/Misses | Time (ms) | Ordered by | Pipeline            |
+------------------+--------------------+----------------+------+---------+----------------+------------------------+-----------+------------+---------------------+
| +ProduceResult s | p                  |             14 |   14 |       0 |                |                    2/0 |     0.178 |            |                     |
| |                +--------------------+----------------+------+---------+----------------+------------------------+-----------+            |                     |
...
| |                +--------------------+----------------+------+---------+----------------+                        |           |                     |
| +NodeByLabelScan | p:Location         |             10 |   10 |      11 |            120 |                    3/0 |     0,171 | Fused in Pipeline 0 |
+------------------+--------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
...
| +CacheProperties | cache[l.name]                             |             10 |   10 |      10 |                |                        |           |                     |
| |                +-------------------------------------------+----------------+------+---------+----------------+                        |           |                     |
| +NodeByLabelScan | l:Location                                |             10 |   10 |      35 |            120 |                    5/0 |     0,422 | Fused in Pipeline 0 |
+------------------+-------------------------------------------+----------------+------+---------+----------------+------------------------+-----------+---------------------+
