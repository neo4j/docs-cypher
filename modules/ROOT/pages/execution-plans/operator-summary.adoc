...
| Used to ensure that no node property uniqueness constraints are violated.
|
|
|

| xref::execution-plans/operators.adoc#query-plan-assert-same-relationship[AssertSameRelationship]
| Used to ensure that no relationship property uniqueness constraints are violated.
|
|
|
