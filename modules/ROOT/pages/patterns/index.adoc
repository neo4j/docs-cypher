...
* xref:patterns/path-modes.adoc[] - information about Cypher's different path modes, which determine whether nodes and relationships can appear more than once in a graph pattern match.
