...
<<<<<<< HEAD:modules/ROOT/pages/patterns/path-modes.adoc
...
>>>>>>> 1145baa3 (Patterns restructure (avoid Match/path mode terminology outside Reference section) (#1526)):modules/ROOT/pages/patterns/acyclic-paths.adoc
