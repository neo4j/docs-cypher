...
For more information about Cypher's default `MATCH` behavior, see xref:patterns/reference/match-modes-and-path-modes.adoc#match-modes-rules-different-relationships[Syntax & semantics -> Match modes].
