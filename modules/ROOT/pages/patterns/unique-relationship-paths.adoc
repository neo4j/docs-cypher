...
* link:{neo4j-docs-base-uri}/cypher-manual/25/patterns/repeatable-node-and-relationship-paths/[Cypher 25 -> Paths with repeatable nodes and relationships]
* link:{neo4j-docs-base-uri}/cypher-manual/25/patterns/acyclic-paths/[Cypher 25 -> Acyclic paths]
