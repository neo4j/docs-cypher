...
The section on xref:patterns/unique-relationship-matching.adoc#default-traversal-rules-and-konigsberg-bridges-problem[Cypher's default traversal rules and the Königsberg bridges problem] showed the impossibility of crossing each of the seven bridges in Königsberg exactly once in a single walk.
