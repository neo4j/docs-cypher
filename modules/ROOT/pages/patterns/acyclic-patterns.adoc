...
By default, Cypher only prevents relationships being repeated in a `MATCH` result, not nodes (see xref:patterns/unique-relationship-patterns.adoc[] for more information).
