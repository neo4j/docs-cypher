...
that pass through each of the intermediate routers. By grouping the paths on the intermediate nodes and calculating
the percentage of paths that pass through each router, the sensitivity of the network to a failure at that router
can be determined:
