...
* `ACYCLIC`: nodes cannot be repeated within a path, which also means relationships cannot be repeated;
a node can, however, be repeated across paths, enabling equijoins to be formed.
...
Also see xref:pattern/reference.adoc#path-modes[].
