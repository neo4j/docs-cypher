...
Whether or not a graph pattern can match a relationship more than once is governed by the selected xref:patterns/reference/match-modes-and-path-modes.adoc#match-modes[match mode].
