...
Both Cypher and link:https://neo4j.com/docs/graph-data-science/current/[Neo4j´s Graph Data Science (GDS) library] can be used to find variations of the shortest paths between nodes.
