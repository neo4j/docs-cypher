...
image::patterns-equijoins-motif.svg[Graph using the London railway example connecting stations via calls at and next relationships,width=600,role=popup]
...
image::patterns-equijoins-motif2.svg[Graph using the London railway example connecting stations via calls at and next relationships,width=600,role=popup]
