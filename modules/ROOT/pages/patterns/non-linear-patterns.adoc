...
image::patterns-equijoins-solution2.svg[Example graph showing a path with a cycle,width=600,role=popup]
...
image::patterns-equijoins-motif.svg[Motif using the London railway example connecting stations via calls at and next relationships,width=600,role=popup]
...
image::patterns-equijoins-motif2.svg[Motif using the London railway example connecting stations via calls at and next relationships,width=600,role=popup]
