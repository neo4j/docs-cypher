...
image::patterns-qpp-motif1.svg[Example of a fixed-length path pattern that matches the service that departs from Denmark Hill station,width=600,role=popup]
