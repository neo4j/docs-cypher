...
[role=label--new-5.16]
[[create-a-node-property-type-constraint-by-param]]
...
[role=label--new-5.11]
[[create-a-node-property-type-constraint-union]]
...
[[create-a-node-property-type-constraint-if-not-exist]]
...
[[node-property-constraint-fail-cases]]
=== Fail cases

* xref:constraints/type.adoc#create-an-already-existing-node-property-type-constraint[]
* xref:constraints/type.adoc#create-a-different-than-existing-node-property-type-constraint[]
* xref:constraints/type.adoc#create-node-property-type-constraints-on-invalid-types[]
* xref:constraints/type.adoc#create-a-node-that-complies-with-a-property-type-constraint[]
* xref:constraints/type.adoc#create-a-node-that-violates-a-property-type-constraint[]
* xref:constraints/type.adoc#fail-to-create-a-property-type-constraint-due-to-existing-node[]
...
[[create-a-different-than-existing-node-property-type-constraint]]
...
[[create-node-property-type-constraints-on-invalid-types]]
...
[[create-a-node-that-complies-with-a-property-type-constraint]]
...
[[create-a-node-that-violates-a-property-type-constraint]]
...
[[fail-to-create-a-property-type-constraint-due-to-existing-node]]
...
[role=label--new-5.11]
[[create-a-relationship-property-type-constraint-union]]
...
[[relationship-property-constraint-fail-cases]]
=== Fail cases

* xref:constraints/type.adoc#create-an-already-existing-relationship-property-type-constraint[]
* xref:constraints/type.adoc#create-a-different-than-existing-relationship-property-type-constraint[]
* xref:constraints/type.adoc#create-relationship-property-type-constraints-on-invalid-types[]
* xref:constraints/type.adoc#create-a-relationship-that-complies-with-a-property-type-constraint[]
* xref:constraints/type.adoc#create-a-relationship-that-violates-a-property-type-constraint[]
* xref:constraints/type.adoc#fail-to-create-a-property-type-constraint-due-to-existing-relationship[]
...
[[create-a-different-than-existing-relationship-property-type-constraint]]
==== Creating a constraint when there is an existing constraint with a different property type will fail
...
[[create-relationship-property-type-constraints-on-invalid-types]]
==== Creating constraints on invalid types will fail
...
[[create-a-relationship-that-complies-with-a-property-type-constraint]]
...
[[create-a-relationship-that-violates-a-property-type-constraint]]
...
[[fail-to-create-a-property-type-constraint-due-to-existing-relationship]]
