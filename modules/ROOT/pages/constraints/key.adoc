...
Key constraints ensure that, for a given node label/relationship type and set of properties:

* All the properties exist on all the nodes with the specified label or all the relationships with the specified type.
*  The combination of the property values is unique.

Queries attempting to do any of the following will fail:

* Create new nodes or relationships without all the properties or where the combination of property values is not unique.
...
[role=label--new-5.16]
[[create-a-node-key-constraint-by-param]]
...
[[create-a-node-key-constraint-if-not-exist]]
...
[[create-a-node-key-constraint-with-index-provider]]
...
[[node-key-constraints-fail-cases]]
=== Fail cases

* xref:constraints/key.adoc#node-key-and-uniqueness-constraint-on-the-same-schema[]
* xref:constraints/key.adoc#create-a-node-key-constraint-with-the-same-name-as-existing-index[]
* xref:constraints/key.adoc#create-a-node-that-complies-with-a-node-key-constraint[]
* xref:constraints/key.adoc#create-a-node-that-violates-a-node-key-constraint[]
* xref:constraints/key.adoc#removing-a-node-key-constrained-property[]
* xref:constraints/key.adoc#fail-to-create-a-node-key-constraint-due-to-existing-node[]


[[node-key-and-uniqueness-constraint-on-the-same-schema]]
...
[[create-a-node-key-constraint-with-the-same-name-as-existing-index]]
...
[[create-a-node-that-complies-with-a-node-key-constraint]]
...
[[fail-to-create-a-node-key-constraint-due-to-existing-node]]
...
[role=label--new-5.16]
[[create-a-relationship-key-constraint-by-param]]
...
[[create-a-relationship-key-constraint-if-not-exist]]
=== Handling existing constraints when creating a constraint
...
[[relationship-key-constraints-fail-cases]]
=== Fail cases

* xref:constraints/key.adoc#relationship-key-and-uniqueness-constraint-on-the-same-schema[]
* xref:constraints/key.adoc#create-a-relationship-key-constraint-with-the-same-name-as-existing-index[]
* xref:constraints/key.adoc#create-a-relationship-that-complies-with-a-relationship-key-constraint[]
* xref:constraints/key.adoc#create-a-relationship-that-violates-a-relationship-key-constraint[]
* xref:constraints/key.adoc#removing-a-relationship-key-constrained-property[]
* xref:constraints/key.adoc#fail-to-create-a-relationship-key-constraint-due-to-existing-relationship[]

[[relationship-key-and-uniqueness-constraint-on-the-same-schema]]
...
[[create-a-relationship-key-constraint-with-the-same-name-as-existing-index]]
==== Creating a constraint on same name as an existing index will fail
...
[[create-a-relationship-that-complies-with-a-relationship-key-constraint]]
...
[[fail-to-create-a-relationship-key-constraint-due-to-existing-relationship]]
