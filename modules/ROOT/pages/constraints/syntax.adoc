...
Creating a constraint requires xref:access-control/database-administration.adoc#access-control-database-administration-constraints[the `CREATE CONSTRAINT` privilege].
...
Dropping a constraint requires xref:access-control/database-administration.adoc#access-control-database-administration-constraints[the `DROP CONSTRAINT` privilege].
...
This requires xref:access-control/database-administration.adoc#access-control-database-administration-constraints[the `SHOW CONSTRAINT` privilege].
