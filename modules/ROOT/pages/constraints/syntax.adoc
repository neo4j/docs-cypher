...
In the case when nothing happens an informational notification will be returned showing the pre-existing constraint blocking the creation.
...
In the case when nothing happens an informational notification will be returned detailing that the constraint does not exist.
