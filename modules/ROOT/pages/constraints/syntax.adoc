...
[[administration-constraints-syntax-create-node-unique]]
[discrete]
...
[[administration-constraints-syntax-create-rel-unique]]
[discrete]
=== Create a unique relationship property constraint

This command creates a uniqueness constraint on relationships with the specified relationship type and properties.
...
[[administration-constraints-syntax-create-rel-key]]
[discrete]
...
[[administration-constraints-syntax-list-type-filter]]
.Type filters
...
|NODE UNIQUE[NESS]
| Returns the node unique property constraints.

|REL[ATIONSHIP] UNIQUE[NESS]
| Returns the relationship unique property constraints.

|UNIQUE[NESS]
| Returns all unique property constraints, for both nodes and relationships.
