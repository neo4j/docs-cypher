...
|NODE UNIQUE[NESS]
| Returns the node uniqueness constraints.

|REL[ATIONSHIP] UNIQUE[NESS]
| Returns the relationship uniqueness constraints.

|UNIQUE[NESS]
| Returns all uniqueness constraints, for both nodes and relationships.
