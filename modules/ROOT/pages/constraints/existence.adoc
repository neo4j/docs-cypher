...
Property existence constraints ensure that a property exists either for all nodes with a specific label or for all relationships with a specific types.
...
[role=label--new-5.16]
[[create-a-node-property-existence-constraint-by-param]]
...
[[create-a-node-property-existence-constraint-if-not-exist]]
...
[[node-existence-constraints-fail-cases]]
=== Fail cases

xref:constraints/existence.adoc#create-an-already-existing-node-property-existence-constraint[]
xref:constraints/existence.adoc#create-a-node-that-complies-with-a-property-existence-constraint[]
xref:constraints/existence.adoc#create-a-node-that-violates-a-property-existence-constraint[]
xref:constraints/existence.adoc#removing-an-existence-constrained-node-property[]
xref:fail-to-create-a-property-existence-constraint-due-to-existing-node[]
...
[[create-a-node-that-complies-with-a-property-existence-constraint]]
...
[[fail-to-create-a-property-existence-constraint-due-to-existing-node]]
...
[[elationship-property-existence]]
...
[role=label--new-5.16]
[[create-a-relationship-property-existence-constraint-by-param]]
...
[[create-a-relationship-property-existence-constraint-if-not-exist]]
=== Handling existing constraints when creating a constraint
...
[[relationship-existence-constraints-fail-cases]]
=== Fail cases

* xref:constraints/existence.adoc#create-an-already-existing-relationship-property-existence-constraint[]
* xref:constraints/existence.adoc#create-a-relationship-that-complies-with-a-property-existence-constraint[]
* xref:constraints/existence.adoc#create-a-relationship-that-violates-a-property-existence-constraint[]
* xref:constraints/existence.adoc#removing-an-existence-constrained-relationship-property[]
* xref:constraints/existence.adoc#fail-to-create-a-property-existence-constraint-due-to-existing-relationship[]
...
[[create-a-relationship-that-complies-with-a-property-existence-constraint]]
...
[[fail-to-create-a-property-existence-constraint-due-to-existing-relationship]]
