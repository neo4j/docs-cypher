...
// TODO: Update all relationship type and property keys to be the same in the whole section (preferably related to the actor/author/book examples in the other sections)
// TODO: also update the result format to match browser output
