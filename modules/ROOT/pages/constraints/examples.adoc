...
Constraint( id=4, name='book_published', type='UNIQUENESS', schema=(:Book {published}), ownedIndex=3 )
----
...
[source, cypher, role=test-setup]
----
CREATE INDEX preExistingIndex FOR (book:Book) ON (book.wordCount)
----
////
...
[source, cypher, role=test-setup]
----
CREATE CONSTRAINT author_birth FOR (author:Author) REQUIRE author.born IS NOT NULL
----
////
...
----
Constraint already exists:
Constraint( id=4, name='author_birth', type='NODE PROPERTY EXISTENCE', schema=(:Author {born}) )
----
...
Assuming that a constraint with the name `rel_constraint_name` already existed:
...
[source, cypher, role=test-setup]
----
CREATE CONSTRAINT wrote_location FOR ()-[wrote:WROTE]-() REQUIRE wrote.location IS NOT NULL
----
////
...
[source, error]
----
An equivalent constraint already exists, 'Constraint( id=4, name='wrote_location', type='RELATIONSHIP PROPERTY EXISTENCE', schema=()-[:WROTE {location}]-() )'.
----
...
[source, cypher, role=test-setup]
----
CREATE CONSTRAINT preExistingUniqueness FOR (actor:Actor) REQUIRE (actor.firstname, actor.age) IS UNIQUE
----
////
...
[source, cypher, role=test-fail]
----
CREATE CONSTRAINT actor_fullname FOR (actor:Actor) REQUIRE (actor.firstname, actor.age) IS NODE KEY
----
...
----
Constraint already exists:
Constraint( id=10, name='preExistingUniqueness', type='UNIQUENESS', schema=(:Actor {firstname, age}), ownedIndex=9 )
----
...
| 11 | "author_pseudonym"         | "UNIQUENESS"                      | "NODE"         | ["Author"]    | ["pseudonym"]            | "author_pseudonym"         |
| 3  | "book_isbn2"               | "NODE_PROPERTY_EXISTENCE"         | "NODE"         | ["Book"]      | ["isbn"]                 | NULL                       |
| 5  | "constraint_with_options"  | "UNIQUENESS"                      | "NODE"         | ["Book"]      | ["prop1", "prop2"]       | "constraint_with_options"  |
| 18 | "constraint_with_provider" | "NODE_KEY"                        | "NODE"         | ["Actor"]     | ["surname"]              | "constraint_with_provider" |
| 16 | "key_constraint_name"      | "NODE_KEY"                        | "NODE"         | ["Actor"]     | ["firstname", "surname"] | "key_constraint_name"      |
| 12 | "preExistingNodePropExist" | "NODE_PROPERTY_EXISTENCE"         | "NODE"         | ["Author"]    | ["born"]                 | NULL                       |
| 7  | "preExistingUnique"        | "UNIQUENESS"                      | "NODE"         | ["Book"]      | ["published"]            | "preExistingUnique"        |
| 20 | "preExistingUniqueness"    | "UNIQUENESS"                      | "NODE"         | ["Actor"]     | ["firstname", "age"]     | "preExistingUniqueness"    |
| 14 | "relPropExist"             | "RELATIONSHIP_PROPERTY_EXISTENCE" | "RELATIONSHIP" | ["WROTE"]     | ["location"]             | NULL                       |
| 13 | "rel_constraint_name"      | "RELATIONSHIP_PROPERTY_EXISTENCE" | "RELATIONSHIP" | ["WROTE"]     | ["year"]                 | NULL                       |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+
11 rows
----
