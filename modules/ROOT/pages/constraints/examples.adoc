...
Assuming no constraint with the name `author_pseudonym` already existed:
...
Create a node property existence constraint on the property `born` on nodes with the `Author` label, when that constraint already exists.

////
[source, cypher, role=test-setup]
----
CREATE CONSTRAINT preExisting_author_birth FOR (author:Author) REQUIRE author.born IS NOT NULL
----
////
...
[source, cypher, role=test-fail]
----
CREATE CONSTRAINT author_birth
...
----
Constraint already exists:
Constraint( id=4, name='preExisting_author_birth', type='NODE PROPERTY EXISTENCE', schema=(:Author {born}) )
----
...
Create an `Author` node with a `name` and `born` property.
...
Assuming that a constraint with the name `wrote_year` already existed:
...
[source, cypher, role=test-setup]
----
CREATE CONSTRAINT preExisting_wrote_location FOR ()-[wrote:WROTE]-() REQUIRE wrote.location IS NOT NULL
----
////
...
[source, cypher, role=test-fail]
----
CREATE CONSTRAINT wrote_location
...
[source, error]
----
An equivalent constraint already exists, 'Constraint( id=4, name='preExisting_wrote_location', type='RELATIONSHIP PROPERTY EXISTENCE', schema=()-[:WROTE {location}]-() )'.
----
...
[source, cypher]
----
CREATE CONSTRAINT new_key_constraint_name IF NOT EXISTS
FOR (actor:Actor) REQUIRE (actor.firstname, actor.surname) IS NODE KEY
----
...
[source, cypher, role=test-setup]
----
CREATE CONSTRAINT preExisting_actor_fullname FOR (actor:Actor) REQUIRE (actor.firstname, actor.age) IS UNIQUE
----
////
...
[source, cypher, role=test-fail]
----
CREATE CONSTRAINT preExisting_actor_fullname FOR (actor:Actor) REQUIRE (actor.firstname, actor.age) IS NODE KEY
----
...
----
Constraint already exists:
Constraint( id=10, name='actor_fullname', type='UNIQUENESS', schema=(:Actor {firstname, age}), ownedIndex=9 )
----
...
FOR (person:Person) REQUIRE person.citizenship IS NODE KEY
----
...
[source, cypher, role=test-fail]
----
CREATE (actor:Actor {firstname: 'Elijah'})
----
...
+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5  | "author_name"                | "NODE_PROPERTY_EXISTENCE"         | "NODE"         | ["Author"]    | ["name"]                 | NULL                         |
| 7  | "author_pseudonym"           | "UNIQUENESS"                      | "NODE"         | ["Author"]    | ["pseudonym"]            | "author_pseudonym"           |
| 15 | "book_isbn2"                 | "NODE_PROPERTY_EXISTENCE"         | "NODE"         | ["Book"]      | ["isbn"]                 | NULL                         |
| 24 | "constraint_with_options"    | "UNIQUENESS"                      | "NODE"         | ["Book"]      | ["prop1", "prop2"]       | "constraint_with_options"    |
| 16 | "constraint_with_provider"   | "NODE_KEY"                        | "NODE"         | ["Actor"]     | ["surname"]              | "constraint_with_provider"   |
| 13 | "key_constraint_name"        | "NODE_KEY"                        | "NODE"         | ["Actor"]     | ["firstname", "surname"] | "key_constraint_name"        |
| 18 | "preExisting_actor_fullname" | "UNIQUENESS"                      | "NODE"         | ["Actor"]     | ["firstname", "age"]     | "preExisting_actor_fullname" |
| 9  | "preExisting_author_birth"   | "NODE_PROPERTY_EXISTENCE"         | "NODE"         | ["Author"]    | ["born"]                 | NULL                         |
| 2  | "preExisting_book_published" | "UNIQUENESS"                      | "NODE"         | ["Book"]      | ["published"]            | "preExisting_book_published" |
| 11 | "preExisting_wrote_location" | "RELATIONSHIP_PROPERTY_EXISTENCE" | "RELATIONSHIP" | ["WROTE"]     | ["location"]             | NULL                         |
| 10 | "wrote_year"                 | "RELATIONSHIP_PROPERTY_EXISTENCE" | "RELATIONSHIP" | ["WROTE"]     | ["year"]                 | NULL                         |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
11 rows
----
