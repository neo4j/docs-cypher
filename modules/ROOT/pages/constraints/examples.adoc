...
This does not guarantee that there is no other offending nodes in the data, therefore all the data should be checked and cleaned up before re-attempting the constraint creation.
...
This does not guarantee that there is no other offending relationships in the data, therefore all the data should be checked and cleaned up before re-attempting the constraint creation.
