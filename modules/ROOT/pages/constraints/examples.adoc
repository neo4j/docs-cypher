...
=== Create a node property type constraint with a union type label:new[Introduced in 5.11]
...
=== Create a relationship property type constraint with a union type label:new[Introduced in 5.11]
