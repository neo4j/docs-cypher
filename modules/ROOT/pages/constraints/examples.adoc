...
// lucene+native-3.0 provider has been replaced with the TEXT index ...?
// range-1.0 provider has no configuration settings.

The valid B-tree (`indexProvider: 'native-btree-1.0'`) configuration settings are:
