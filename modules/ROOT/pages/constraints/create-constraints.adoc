...
It is updated to say `Node property uniqueness constraints added: 1` in Cypher 25.
...
It is updated to say `Relationship property uniqueness constraints added: 1` in Cypher 25.
======
...
[NOTE]
The constraint type is updated to say `RELATIONSHIP PROPERTY UNIQUENESS` in Cypher 25.
======
...
[NOTE]
The constraint type is updated to say `NODE PROPERTY UNIQUENESS` in Cypher 25.
