...
[NOTE]
The constraint type is updated to say `RELATIONSHIP PROPERTY UNIQUENESS` in a future version of Neo4j.
======
...
[NOTE]
The constraint type is updated to say `NODE PROPERTY UNIQUENESS` in a future version of Neo4j.
