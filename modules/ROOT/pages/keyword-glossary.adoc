...
| xref:administration/access-control/manage-privileges.adoc#access-control-graph-privileges[DENY [IMMUTABLE\] ... ON GRAPH ... [NODES \| RELATIONSHIPS \| ELEMENTS \| FOR\] ... TO]
| Privilege
...
| xref:administration/access-control/manage-privileges.adoc#access-control-graph-privileges[GRANT [IMMUTABLE\] ... ON GRAPH ... [NODES \| RELATIONSHIPS \| ELEMENTS \| FOR\] ... TO]
| Privilege
...
| xref:administration/access-control/manage-privileges.adoc#access-control-revoke-privileges[REVOKE [IMMUTABLE\] [GRANT \| DENY\] ... ON GRAPH ... [NODES \| RELATIONSHIPS \| ELEMENTS \| FOR\] ... FROM]
| Privilege
