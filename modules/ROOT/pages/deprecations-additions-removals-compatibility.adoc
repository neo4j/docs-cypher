...
Added a new Cypher clause to query configuration settings.
...
[source, cypher, role="noheader"]
----
GRANT SHOW SETTING[S] name-globbing[,...]
DENY SHOW SETTING[S] name-globbing[,...]
----
a|

Added new `SHOW SETTING` privileges to grant or deny access for desired configuration settings to specific roles.
