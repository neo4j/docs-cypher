...
Extended xref:expressions/type-predicate.adoc[type predicate expressions].
...
Added xref:expressions/type-predicate.adoc[type predicate expressions].
...
RETURN size([ (a)-[]->(b) \| a ])
----
See xref:functions/scalar.adoc#functions-size[size()] and xref:expressions/subquery.adoc#count[Count Subqueries] for more details.
|===
