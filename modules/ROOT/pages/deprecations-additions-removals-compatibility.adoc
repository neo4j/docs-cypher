...
Added relationship xref:schema/constraints.adoc#create-key-constraints[key] and xref:schema/constraints.adoc#create-property-uniqueness-constraints[property uniqueness] constraints.
