...
The parallel runtime takes full advantage of the available CPUs to significantly reduce the time of large Cypher read-queries run against databases with low concurrency.
|===
