...
| Extended xref:indexes/indexes-for-search-performance.adoc#indexes-list-indexes[`SHOW INDEXES`] with easy filtering for vector indexes.
...
----
a|
xref:indexes/indexes-for-search-performance.adoc#indexes-drop-an-index[New command] for dropping an index by name.
...
| xref:indexes/indexes-for-search-performance.adoc[Composite indexes] | Index | Added |
