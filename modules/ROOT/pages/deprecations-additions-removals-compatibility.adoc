...
[IMPORTANT]
Cypher 25 was introduced in Neo4j 2025.04 and can only be used on 2025.04+ databases.
Features removed in Cypher 25 are still available on Neo4j 2025.04+ databases either by prepending a query with `CYPHER 5` or by having Cypher 5 as the default language for the database.
