...
| Function
| Added
| See xref::functions/scalar.adoc#functions-toboolean[`toBoolean()`].
...
| Function
| Added
| See xref::functions/scalar.adoc#functions-properties[`properties()`].
...
| Function
| Added
| See xref::functions/spatial.adoc#functions-distance[`distance()`].
