...
| Introduced the new `FULLTEXT` keyword for full-text search functionality. This entry contains placeholder text and should be replaced with the final syntax and behavior details.
|===
