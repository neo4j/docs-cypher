...
AWESOME QUERY
----
| In projection clauses, aliases for projection items now always take precedence over incomgin variables. See xref:link/to-file.adoc[awesome link] for details.
|===
