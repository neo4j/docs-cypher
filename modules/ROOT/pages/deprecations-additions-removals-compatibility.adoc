...
----
| Show users can now return the command to recreate the user.
link:{neo4j-docs-base-uri}/operations-manual/current/authentication-authorization/manage-users/[Operations Manual -> Manage users]
...
----
| Show roles can now return the commands to recreate the role and assign users and auth rules.
link:{neo4j-docs-base-uri}/operations-manual/current/authentication-authorization/manage-roles/[Operations Manual -> Manage roles]
