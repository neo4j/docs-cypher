...
a| New xref:patterns/path-modes.adoc[path modes] have been added to Cypher, determining together with xref:patterns/match-modes.adoc[match modes] whether or not nodes and relationships can appear more than once in a graph pattern match.
