...
Extended xref::constraints/type.adoc[node and relationship property type constraints].
...
Added xref::constraints/type.adoc[node and relationship property type constraints].
...
| xref:constraints/type.adoc[Node Key] | Index | Added | Neo4j Enterprise Edition only
