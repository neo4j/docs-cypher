...
Extended xref:expressions/predicate-expressions/type-predicate-expressions.adoc[type predicate expressions].
...
Added xref:expressions/predicate-expressions/type-predicate-expressions.adoc[type predicate expressions].
