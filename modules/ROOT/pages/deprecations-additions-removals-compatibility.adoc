...
RETURN coll.zip(list1, list2)
----

| Introduction of the xref:functions/list.adoc#functions-coll-zip[`coll.zip()`] function, which returns a list of lists formed by combining the elements at each index across two or more given lists.
