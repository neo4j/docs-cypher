...
For more information, see link:{neo4j-docs-base-uri}/operations-manual/current/authentication-authorization/manage-privileges/#access-control-list-privileges[`SHOW PRIVILEGES` (Operations Manual)].
...
----
| Several new columns for filtering has been added to the `SHOW PRIVILEGES AS [REVOKE] COMMANDS` commands output.
