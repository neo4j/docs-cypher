...
Extended xref::constraints/managing-constraints.adoc#create-type-constraint-union-type[node and relationship property type constraints].
...
Added xref::constraints/managing-constraints.adoc#create-type-constraint[node and relationship property type constraints].
...
Added relationship xref:constraints/managing-constraints.adoc#create-key-constraint[key] and xref:constraints/managing-constraints.adoc#create-uniqueness-constraint[uniqueness] constraints.
