...
For more information, see the link:{neo4j-docs-base-uri}/operations-manualcurrent/authentication-authorization/dbms-administration/dbms-user-management-privileges/#_grant_privilege_to_show_users_as_commands[Operations Manual -> Grant privilege to show users as commands].
|===
