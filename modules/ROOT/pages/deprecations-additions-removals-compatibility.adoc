...
a| Introduced a xref:query-caches/index.adoc#query-size-limit[query size limit] for a query to be considered for query caching. This limit is used to prevent huge generated query text strings from occupying memory in the query cache.
|===
