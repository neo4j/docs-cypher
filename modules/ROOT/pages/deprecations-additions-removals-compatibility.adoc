...
| xref:functions/aggregating.adoc#functions-stdev[`stDev()`], xref:functions/aggregating.adoc#functions-stdev-samp[`stdev_samp()`], xref:functions/aggregating.adoc#functions-stdevp[`stDevP()`], and ref:functions/aggregating.adoc#functions-stdev-pop[`stdev_pop()`] now return `null` instead of `0` when given a `null` argument.
