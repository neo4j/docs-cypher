...
Added relationship xref:schema/constraints/create-constraints.adoc#create-key-constraints[key] and xref:schema/constraints/create-constraints.adoc#create-property-uniqueness-constraints[property uniqueness] constraints.
