...
Added the operator xref:planning-and-tuning/operators/operators-detail.adoc#query-plan-remote-node-index-seek[`RemoteNodeIndexSeek`].
a| xref:planning-and-tuning/operators/operators-detail.adoc#query-plan-remote-node-index-seek[`RemoteNodeIndexSeek`] is .
|===
