...
GROUP BY <query>
----
| A new xref:clauses/group-by.adoc[GROUP BY] subclause for `WITH` and `RETURN` has been added which is used for grouping results by a grouping element or a list of grouping elements.
|===
