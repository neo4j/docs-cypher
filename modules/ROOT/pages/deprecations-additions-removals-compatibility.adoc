...
ORDER BY genre
----
| The visibility of expressions in WHERE and ORDER BY clauses has been streamlined. See xref:functions/aggregating.adoc#grouping-keys[Aggregating expressions and grouping keys] for details.
|===
