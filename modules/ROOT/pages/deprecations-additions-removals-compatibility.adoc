...
a|
label:new[]
Added the two Infinigraph-specific query operators xref:planning-and-tuning/operators/operators-detail.adoc#query-plan-remote-node-index-seek[`RemoteNodeIndexSeek`] and xref:planning-and-tuning/operators/operators-detail.adoc#query-plan-remote-unique-node-index-seek[`RemoteUniqueNodeIndexSeek`].
