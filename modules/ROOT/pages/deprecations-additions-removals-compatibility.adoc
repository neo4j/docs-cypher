...
----
a|
New sub-clause `WAIT` for `ALTER DATABASE`, which allows adding a waiting clause allows you to specify a time limit in which the command must complete and return.
|===
