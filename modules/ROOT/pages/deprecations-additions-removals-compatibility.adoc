...
[[cypher-deprecations-additions-removals-2026.11]]
== Neo4j 2026.11
...
----
vector($list, $dimension, FLOAT16)
vector($list, $dimension, BFLOAT16)
----

| Introduction of new vector coordinate types; `BFLOAT16` and `FLOAT16`, which can be in `VECTOR` type contexts e.g the xref:functions/vector.adoc#functions-vector[vector() constructor function.]
