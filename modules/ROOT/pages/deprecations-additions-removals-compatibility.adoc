...
The `setting-name` is a comma-separated list of one or more quoted strings, a string parameter, or a list parameter.

This replaces the procedure `dbms.listConfig`.
...
New privilege that controls user's access to desired configuration settings.
