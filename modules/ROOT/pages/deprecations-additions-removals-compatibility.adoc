...
[IMPORTANT]
Cypher 25 is the default Cypher version in Neo4j 2026.02+ databases.
...
Cyper 25 is now the default Cypher version for new databases.
a| Cyper 25 is the default Cypher version for new self-managed installations and new Aura instances.
...
The setting can be changed manually for both, see xref:queries/select-version.adoc#select-default-cypher-version[Select the default Cypher version for a database].
+
