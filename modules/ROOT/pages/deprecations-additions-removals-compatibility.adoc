...
See xref::functions/scalar.adoc#functions-length[`length()`] for more details.
...
See xref::functions/scalar.adoc[`size()`] for more details.
...
| Function
| Removed
| Replaced by xref::functions/predicate.adoc#functions-exists[`exists()`].

| `str()`
| Function
| Removed
| Replaced by xref::functions/string.adoc#functions-tostring[`toString()`].
