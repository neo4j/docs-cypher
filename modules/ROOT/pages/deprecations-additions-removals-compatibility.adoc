...
----
| A new xref:clauses/group-by.adoc[GROUP BY] subclause for `WITH` and `RETURN` has been added which lets user explicitly state the grouping keys for the query.
