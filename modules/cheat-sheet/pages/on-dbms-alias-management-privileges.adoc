...
= link:{neo4j-docs-base-uri}/operations-manual/current/authentication-authorization/dbms-administration/dbms-alias-management-privileges/[ON DBMS - ALIAS MANAGEMENT Privileges^]
