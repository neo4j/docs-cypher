...
[.description]
Show all servers running in the cluster (including servers that have yet to be enabled as well as dropped servers) and return default columns (`name`, `address`, `state`, `health`, and `hosting`).
