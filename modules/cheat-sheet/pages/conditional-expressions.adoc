...
====
include::ROOT:expressions/conditional-expressions.adoc[tag=expressions_conditional_expressions_simple]
...
====
include::ROOT:expressions/conditional-expressions.adoc[tag=expressions_conditional_expressions_extended_simple]
...
====
include::ROOT:expressions/conditional-expressions.adoc[tag=expressions_conditional_expressions_generic]
...
====
include::ROOT:expressions/conditional-expressions.adoc[tag=expressions_conditional_expressions_properties]
