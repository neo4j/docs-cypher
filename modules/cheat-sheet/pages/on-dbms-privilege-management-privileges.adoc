...
= link:{neo4j-docs-base-uri}/operations-manual/current/authentication-authorization/dbms-administration/dbms-privilege-management-privileges/[ON DBMS - PRIVILEGE MANAGEMENT Privileges^]
